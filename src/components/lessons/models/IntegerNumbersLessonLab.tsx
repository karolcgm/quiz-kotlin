...
function TemperatureMap({ cities }: { cities: TemperatureTask["cities"] }) {
  return (
    <figure className="overflow-hidden rounded-3xl border-2 border-sky-200 bg-gradient-to-b from-sky-100 to-cyan-50 p-3 shadow-sm">
      <svg role="img" aria-label="Mapa Polski z zaznaczonymi temperaturami" viewBox="0 0 600 330" className="mx-auto block w-full max-w-3xl">
        <path d="M110 78 190 40 294 53 392 38 482 88 512 155 468 255 370 284 285 270 214 294 124 250 80 170Z" fill="#bbf7d0" stroke="#15803d" strokeWidth="6" strokeLinejoin="round" />
