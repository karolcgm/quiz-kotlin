...
export function LessonNumericKeypad({ onKey, onConfirm, disabled = false, allowSeparator = false, allowNegative = false, label = "Klawiatura ekranowa", helperText }: Props) {
