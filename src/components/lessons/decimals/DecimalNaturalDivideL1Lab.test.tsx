...
describe("DecimalNaturalDivideL1Lab", () => {
  ...
  it("wymaga dopisania zer, kroków pisemnych i kompletnego ilorazu", () => {
    ...
    fillStep(/Iloczyn do odjęcia, krok 1, cyfra 1/u, ["0"]);
    fillStep(/Liczba po sprowadzeniu, krok 1, cyfra 1/u, ["4", "2"]);
    fillStep(/Iloczyn do odjęcia, krok 2, cyfra 1/u, ["4", "0"]);
    fillStep(/Liczba po sprowadzeniu, krok 2, cyfra 1/u, ["2", "0"]);
    fillStep(/Iloczyn do odjęcia, krok 3, cyfra 1/u, ["1", "6"]);
    fillStep(/Liczba po sprowadzeniu, krok 3, cyfra 1/u, ["4", "0"]);
    fillStep(/Iloczyn do odjęcia, krok 4, cyfra 1/u, ["4", "0"]);
    fillStep(/Liczba po sprowadzeniu, krok 4, cyfra 1/u, ["0"]);
