...
function FractionReviewTaskLessonModel({ phase, readOnly = false, presentationMode = false, teacherNavigationMode = false, questionNumber, questionCount, onResultChange }: FractionReviewLessonModelProps) {
