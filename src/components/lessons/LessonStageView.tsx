  ...
  return (
    <LessonSystemKeyboardGuard><div className="space-y-4">
      ...
      {modelId === "plane-figures-review-lab" ? (
        <PlaneFiguresReviewLessonLab
          key={`${stage.id}-${modelSeed ?? 1}`}
          activity={planeFiguresReviewActivityFromStageId(stage.id)}
          readOnly={readOnly}
        />
      ) : null}
      {modelId === "calendar-time-lab" ? (
        <CalendarTimeLessonLab
          key={`${stage.id}-${modelSeed ?? 1}`}
          activity={calendarTimeActivityFromStageId(stage.id)}
          readOnly={readOnly}
        />
      ) : null}
      ...
      {modelId === "rounding-lab" ? (
        <RoundingLessonLab
          key={`${stage.id}-${modelSeed ?? 1}`}
          activity={roundingActivityFromStageId(stage.id)}
          readOnly={readOnly}
        />
      ) : null}
      ...
      {modelId === "right-prism-lab" ? (
        <RightPrismLessonLab
          key={`${stage.id}-${modelSeed ?? 1}`}
          activity={rightPrismActivityFromStageId(stage.id)}
          readOnly={readOnly}
        />
      ) : null}
      {modelId === "prism-nets-lab" ? (
        <PrismNetsLessonLab
          key={`${stage.id}-${modelSeed ?? 1}`}
          activity={prismNetsActivityFromStageId(stage.id)}
          readOnly={readOnly}
        />
      ) : null}
      {modelId === "prism-surface-area-lab" ? (
      ...
      {modelId === "pyramid-lab" ? (
        <PyramidLessonLab
          key={`${stage.id}-${modelSeed ?? 1}`}
          activity={pyramidActivityFromStageId(stage.id)}
          readOnly={readOnly}
        />
      ) : null}
