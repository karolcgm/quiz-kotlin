...
import { Grade4LengthUnitsLessonLab, grade4LengthUnitsActivityFromStageId } from "@/components/lessons/models/Grade4LengthUnitsLessonLab";
...
export function BoardStageDisplay({
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-8">
      <header className={`space-y-3 text-center ${stage.modelId === "grade4-clock-time-lab" || stage.modelId === "grade4-calendar-lab" || stage.modelId === "grade4-roman-numerals-lab" || stage.modelId === "grade4-mass-units-lab" || stage.modelId === "grade4-length-units-lab" || stage.modelId === "grade4-money-lab" || stage.modelId === "grade4-large-number-arithmetic-lab" || stage.modelId === "grade4-natural-number-comparison-lab" || stage.modelId === "grade4-decimal-system-lab" || stage.modelId === "grade4-section-one-review-lab" || stage.modelId === "grade4-number-line-lab" || stage.modelId === "grade4-order-of-operations-lab" || stage.modelId === "grade4-story-problems-two-lab" || stage.modelId === "grade4-reading-information-two-lab" || stage.modelId === "grade4-reading-information-one-lab" || stage.modelId === "grade4-story-problems-one-lab" || stage.modelId === "grade4-powers-lab" || stage.modelId === "grade4-remainder-division-lab" || stage.modelId === "grade4-times-more-less-lab" || stage.modelId === "grade4-mul-div-continued-lab" || stage.modelId === "grade4-times-ten-lab" || hasSelfContainedVisual || stage.modelId === "grade4-add-sub-lab" || stage.modelId === "grade4-more-less-lab" || stage.modelId === "grade4-mul-div-lab" || stage.modelId === "cuboid-cube-lab" || stage.modelId === "right-prism-lab" || stage.modelId === "prism-nets-lab" || stage.modelId === "prism-volume-lab" || stage.modelId === "pyramid-lab" || stage.modelId === "solid-recognition-lab" || stage.modelId === "solid-review-lab" ? "sr-only" : ""}`}>
      ...
      {questionCount > 1 ? <div className="mx-auto flex w-full max-w-3xl flex-wrap items-center justify-center gap-3 rounded-2xl border border-white/15 bg-white/5 p-3"><button type="button" disabled={questionIndex===0} onClick={()=>selectQuestion(Math.max(0,questionIndex-1))} className="min-h-10 rounded-xl border border-white/20 px-3 text-sm font-bold text-white disabled:opacity-40">← Poprzednie</button>{stage.id.startsWith("m6-") ? <label className="flex min-h-10 items-center gap-2 rounded-xl bg-white px-3 text-sm font-black text-slate-950">Zadanie <select aria-label="Wybierz zadanie" value={questionIndex} onChange={(event) => selectQuestion(Number(event.target.value))} className="rounded-lg border border-slate-300 bg-white px-2 py-1">{stage.questions.map((item, index) => <option key={item.questionInstanceId} value={index}>{index + 1} z {questionCount}</option>)}</select></label> : unifiedTaskModel ? null : <b className="rounded-xl bg-cyan-300 px-4 py-2 text-sm text-cyan-950">Przykład {questionIndex+1} z {questionCount}</b>}<button type="button" disabled={questionIndex===questionCount-1} onClick={()=>selectQuestion(Math.min(questionCount-1,questionIndex+1))} className="min-h-10 rounded-xl bg-white px-3 text-sm font-bold text-slate-950 disabled:opacity-40">Następne →</button></div> : null}
      ...
      ) : stage.modelId === "prism-nets-lab" ? (
        <div className="mx-auto w-full max-w-6xl">
          <PrismNetsLessonLab key={`${stage.id}-${modelSeed}`} activity={prismNetsActivityFromStageId(stage.id)} readOnly={!interactive} />
        </div>
      ...
      ) : stage.modelId === "solid-review-lab" ? (
        <div className="mx-auto w-full max-w-6xl">
          <SolidReviewLessonLab key={`${stage.id}-${modelSeed}`} activity={solidReviewActivityFromStageId(stage.id)} readOnly={!interactive} />
        </div>
      ...
      ) : stage.modelId === "grade4-reading-information-two-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4ReadingInformationTwoLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4ReadingInformationTwoActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-reading-information-one-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4ReadingInformationOneLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4ReadingInformationOneActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-story-problems-one-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4StoryProblemsOneLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4StoryProblemsOneActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-story-problems-two-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4StoryProblemsTwoLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4StoryProblemsTwoActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-order-of-operations-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4OrderOfOperationsLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4OrderOfOperationsActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-section-one-review-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4SectionOneReviewLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4SectionOneReviewActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-decimal-system-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4DecimalSystemLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4DecimalSystemActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-natural-number-comparison-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4NaturalNumberComparisonLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4NaturalNumberComparisonActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-large-number-arithmetic-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4LargeNumberArithmeticLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4LargeNumberArithmeticActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-money-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4MoneyLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4MoneyActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-length-units-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4LengthUnitsLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4LengthUnitsActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-mass-units-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4MassUnitsLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4MassUnitsActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-roman-numerals-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4RomanNumeralsLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4RomanNumeralsActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-calendar-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4CalendarLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4CalendarActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-clock-time-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4ClockTimeLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4ClockTimeActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-number-line-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4NumberLineLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4NumberLineActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-powers-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4PowersLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4PowersActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-remainder-division-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4RemainderDivisionLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4RemainderDivisionActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-times-more-less-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4TimesMoreLessLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4TimesMoreLessActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-mul-div-continued-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4MulDivContinuedLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4MulDivContinuedActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-times-ten-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4TimesTenLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4TimesTenActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-mul-div-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4MulDivLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4MulDivActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
      ) : stage.modelId === "grade4-more-less-lab" ? (
        <div className="mx-auto w-full max-w-6xl"><Grade4MoreLessLessonLab key={question?.questionInstanceId ?? stage.id} activity={grade4MoreLessActivityFromStageId(stage.id)} taskSeed={question?.seed} readOnly={!interactive} questionNumber={question ? questionIndex + 1 : undefined} questionCount={question ? questionCount : undefined} /></div>
