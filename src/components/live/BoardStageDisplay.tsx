...
export function BoardStageDisplay({
  ...
  const hasSelfContainedVisual = stage.modelId === "class4-review" || stage.modelId === "section-one-review-lesson" || stage.modelId === "section-two-review-lesson" || stage.modelId === "natural-numbers-lesson" || stage.modelId === "mental-add-sub-lesson" || stage.modelId === "mental-mul-div-lesson" || stage.modelId === "order-of-operations-lesson" || stage.modelId === "estimation-lesson" || stage.modelId === "written-add-sub-lesson" || stage.modelId === "written-multiplication-lesson" || stage.modelId === "written-division-lesson" || stage.modelId === "written-story-problems-lesson" || stage.modelId === "multiples-lesson" || stage.modelId === "divisors-lesson" || stage.modelId === "divisibility-animals-lesson" || stage.modelId === "prime-composite-lesson" || stage.modelId === "prime-factorization-lesson" || stage.modelId === "gcd-lcm-factor-lesson" || stage.modelId === "place-value-factory" || stage.modelId === "number-line-jumps" || stage.modelId === "diagnostic-stations" || stage.modelId === "exercise-board" || stage.modelId === "geometry-lab" || stage.modelId === "plane-figures-review-lab" || stage.modelId === "calendar-time-lab" || stage.modelId === "everyday-units-lab" || stage.modelId === "map-scale-lab" || stage.modelId === "rounding-lab" || stage.modelId === "calculator-lab" || stage.modelId === "fraction-lesson" || stage.modelId === "decimal-notation-l1" || stage.modelId === "decimal-mental-arithmetic-l6" || stage.modelId === "integer-numbers-lab" || stage.modelId === "integer-add-subtract-lab" || stage.modelId === "integer-mul-div-lab" || stage.modelId === "integer-review-lab" || stage.modelId === "rectangle-square-area-lab" || stage.modelId === "area-unit-conversion-lab" || stage.modelId === "parallelogram-area-lab" || stage.modelId === "rhombus-area-lab" || stage.modelId === "triangle-area-lab" || stage.modelId === "trapezoid-area-lab" || stage.modelId === "composite-area-lab" || stage.modelId === "area-review-lab" || stage.modelId === "volume-units-lab" || stage.modelId === "cuboid-volume-lab" || stage.modelId === "liters-milliliters-lab" || stage.modelId === "volume-review-lab";
  const unifiedTaskModel = stage.modelId === "geometry-lab" || stage.modelId === "plane-figures-review-lab" || stage.modelId === "calendar-time-lab" || stage.modelId === "everyday-units-lab" || stage.modelId === "map-scale-lab" || stage.modelId === "rounding-lab" || stage.modelId === "calculator-lab" || stage.modelId === "fraction-lesson" || stage.modelId === "decimal-notation-l1" || stage.modelId === "integer-numbers-lab" || stage.modelId === "integer-add-subtract-lab" || stage.modelId === "integer-mul-div-lab" || stage.modelId === "integer-review-lab" || stage.modelId === "rectangle-square-area-lab" || stage.modelId === "area-unit-conversion-lab" || stage.modelId === "parallelogram-area-lab" || stage.modelId === "rhombus-area-lab" || stage.modelId === "triangle-area-lab" || stage.modelId === "trapezoid-area-lab" || stage.modelId === "composite-area-lab" || stage.modelId === "area-review-lab" || stage.modelId === "volume-units-lab" || stage.modelId === "cuboid-volume-lab" || stage.modelId === "liters-milliliters-lab" || stage.modelId === "volume-review-lab";
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-8">
      ...
      {stage.modelId === "order-director" ? (
        ...
        <div className="mx-auto w-full max-w-6xl">
          <CalculatorLessonLab activity={calculatorActivityFromStageId(stage.id)} readOnly={!interactive} />
        </div>
        ...
        <div className="mx-auto w-full max-w-6xl">
          <IntegerReviewLessonLab key={`${stage.id}-${modelSeed}`} activity={integerReviewActivityFromStageId(stage.id)} readOnly={!interactive} />
        </div>
