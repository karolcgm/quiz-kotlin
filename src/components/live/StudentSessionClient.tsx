...
export function StudentSessionClient({ sessionId, initialView, initialUnderstanding = null }: StudentSessionClientProps) {
  ...
  const showCompanionActivity =
    ...
    !view.boardOnlyMode &&
    !showActivity &&
    ((stage?.studentModelId === "grade4-clock-time-lab" && question === null) ||
      (stage?.studentModelId === "grade4-calendar-lab" && question === null) ||
      (stage?.studentModelId === "grade4-roman-numerals-lab" && question === null) ||
      (stage?.studentModelId === "grade4-mass-units-lab" && question === null) ||
      (stage?.studentModelId === "grade4-length-units-lab" && question === null) ||
      (stage?.studentModelId === "grade4-money-lab" && question === null) ||
      ...
      (stage?.studentModelId === "grade4-order-of-operations-lab" && question === null) ||
      (stage?.studentModelId === "grade4-number-line-lab" && question === null) ||
      ...
      (stage?.studentModelId === "grade4-mul-div-continued-lab" && question === null) ||
  ...
  const showGrade4DecimalSystem =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-decimal-system-lab" && question?.generatorId === "grade4-decimal-system-l1-v1";
  ...
  const showGrade4Money =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-money-lab" && question?.generatorId === "grade4-money-l1-v1";
  const showGrade4LengthUnits =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-length-units-lab" && question?.generatorId === "grade4-length-units-l1-v1";
  const showGrade4MassUnits =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-mass-units-lab" && question?.generatorId === "grade4-mass-units-l1-v1";
  const showGrade4RomanNumerals =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-roman-numerals-lab" && question?.generatorId === "grade4-roman-numerals-l1-v1";
  const showGrade4Calendar =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-calendar-lab" && question?.generatorId === "grade4-calendar-l1-v1";
  const showGrade4ClockTime =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-clock-time-lab" && question?.generatorId === "grade4-clock-time-l1-v1";
  ...
  const showGrade4MulDivContinued =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-mul-div-continued-lab" && question?.generatorId === "grade4-mul-div-continued-l1-v1";
  const showGrade4TimesMoreLess =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-times-more-less-lab" && question?.generatorId === "grade4-times-more-less-l1-v1";
  const showGrade4RemainderDivision =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-remainder-division-lab" && question?.generatorId === "grade4-remainder-division-l1-v1";
  const showGrade4Powers =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-powers-lab" && question?.generatorId === "grade4-powers-l1-v1";
  ...
  const showGrade4OrderOfOperations =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-order-of-operations-lab" && question?.generatorId === "grade4-order-of-operations-l1-v1";
  ...
  const showGrade4ReadingInformationTwo =
    view.status === "live" && !view.boardOnlyMode &&
    stage?.studentModelId === "grade4-reading-information-two-lab" && question?.generatorId === "grade4-reading-information-two-l1-v1";
    ...
    <div className="student-session mx-auto flex w-full max-w-2xl flex-col gap-4 pb-8">
      ...
      {showCompanionActivity && stage ? (
        <Card className="space-y-4 overflow-hidden p-3 sm:p-5">
          ...
          {stage.studentModelId === "grade4-decimal-system-lab" ? (
            <Grade4DecimalSystemLessonLab activity={grade4DecimalSystemActivityFromStageId(stage.id)} readOnly />
          ) : null}
          ...
          {stage.studentModelId === "grade4-money-lab" ? (
            <Grade4MoneyLessonLab activity={grade4MoneyActivityFromStageId(stage.id)} readOnly />
          ) : null}
          {stage.studentModelId === "grade4-length-units-lab" ? (
            <Grade4LengthUnitsLessonLab activity={grade4LengthUnitsActivityFromStageId(stage.id)} readOnly />
          ) : null}
          {stage.studentModelId === "grade4-mass-units-lab" ? (
            <Grade4MassUnitsLessonLab activity={grade4MassUnitsActivityFromStageId(stage.id)} readOnly />
          ) : null}
          {stage.studentModelId === "grade4-roman-numerals-lab" ? (
            <Grade4RomanNumeralsLessonLab activity={grade4RomanNumeralsActivityFromStageId(stage.id)} readOnly />
          ) : stage.studentModelId === "grade4-calendar-lab" ? (
            <Grade4CalendarLessonLab activity={grade4CalendarActivityFromStageId(stage.id)} readOnly />
          ) : stage.studentModelId === "grade4-clock-time-lab" ? (
            <Grade4ClockTimeLessonLab activity={grade4ClockTimeActivityFromStageId(stage.id)} readOnly />
          ) : null}
          ...
          {stage.studentModelId === "grade4-mul-div-continued-lab" ? (
            <Grade4MulDivContinuedLessonLab activity={grade4MulDivContinuedActivityFromStageId(stage.id)} readOnly />
          ) : null}
          {stage.studentModelId === "grade4-times-more-less-lab" ? (
            <Grade4TimesMoreLessLessonLab activity={grade4TimesMoreLessActivityFromStageId(stage.id)} readOnly />
          ) : null}
          {stage.studentModelId === "grade4-remainder-division-lab" ? (
            <Grade4RemainderDivisionLessonLab activity={grade4RemainderDivisionActivityFromStageId(stage.id)} readOnly />
          ) : null}
          {stage.studentModelId === "grade4-powers-lab" ? (
            <Grade4PowersLessonLab activity={grade4PowersActivityFromStageId(stage.id)} readOnly />
          ) : null}
          ...
          {stage.studentModelId === "grade4-order-of-operations-lab" ? (
            <Grade4OrderOfOperationsLessonLab activity={grade4OrderOfOperationsActivityFromStageId(stage.id)} readOnly />
          ) : null}
          ...
          {stage.studentModelId === "grade4-reading-information-two-lab" ? (
            <Grade4ReadingInformationTwoLessonLab activity={grade4ReadingInformationTwoActivityFromStageId(stage.id)} readOnly />
          ) : null}
      ...
      {showGrade4Money && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4MoneyLessonLab activity={grade4MoneyActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}
      {showGrade4LengthUnits && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4LengthUnitsLessonLab activity={grade4LengthUnitsActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}
      {showGrade4MassUnits && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4MassUnitsLessonLab activity={grade4MassUnitsActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}
      {showGrade4RomanNumerals && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4RomanNumeralsLessonLab activity={grade4RomanNumeralsActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}
      {showGrade4Calendar && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4CalendarLessonLab activity={grade4CalendarActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}
      {showGrade4ClockTime && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4ClockTimeLessonLab activity={grade4ClockTimeActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}
      ...
      {showGrade4MulDivContinued && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4MulDivContinuedLessonLab activity={grade4MulDivContinuedActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}

      {showGrade4TimesMoreLess && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4TimesMoreLessLessonLab activity={grade4TimesMoreLessActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}

      {showGrade4RemainderDivision && stage && question ? <StudentLessonModelActivity key={question.questionInstanceId} sessionId={sessionId} stageId={stageId} question={question} submitted={submitted} questionNumber={questionNumber} questionCount={stage.questions.length} onRefresh={refresh}>{(onResultChange) => <Grade4RemainderDivisionLessonLab activity={grade4RemainderDivisionActivityFromStageId(stage.id)} taskSeed={question.seed} questionNumber={questionNumber} questionCount={stage.questions.length} onResultChange={onResultChange} />}</StudentLessonModelActivity> : null}
