...
export const REWARD_THEMES = [
  ...
  { id: "sunset", name: "Zachód Słońca", points: 300, colors: "from-amber-400 via-orange-500 to-fuchsia-600", emoji: "🌅" },
  { id: "space", name: "Kosmiczna Misja", points: 800, colors: "from-slate-950 via-indigo-950 to-violet-700", emoji: "🪐" },
...
export const AVATAR_FRAMES = [
  ...
  { id: "frame-2", name: "Błękitna", points: 50, className: "ring-8 ring-cyan-300 shadow-[0_0_30px_#67e8f9]" },
  { id: "frame-3", name: "Fioletowy błysk", points: 90, className: "ring-8 ring-violet-400 shadow-[0_0_32px_#a78bfa]" },
  { id: "frame-4", name: "Zachód słońca", points: 140, className: "ring-8 ring-orange-400 shadow-[0_0_34px_#fb7185]" },
  { id: "frame-5", name: "Leśny liść", points: 200, className: "ring-[10px] ring-lime-400 shadow-[0_0_35px_#84cc16]" },
  { id: "frame-6", name: "Kocie łapki", points: 280, className: "ring-[10px] ring-pink-400 shadow-[0_0_36px_#f472b6]" },
  { id: "frame-7", name: "Bobrowa tama", points: 380, className: "ring-[10px] ring-amber-600 shadow-[0_0_38px_#d97706]" },
  { id: "frame-8", name: "Galaktyka", points: 500, className: "ring-[11px] ring-indigo-500 shadow-[0_0_42px_#6366f1]" },
  { id: "frame-9", name: "Tęczowa", points: 650, className: "ring-[11px] ring-fuchsia-400 shadow-[0_0_45px_#22d3ee]" },
  { id: "frame-10", name: "Srebrna", points: 820, className: "ring-[12px] ring-slate-300 shadow-[0_0_45px_#cbd5e1]" },
  { id: "frame-11", name: "Ognista", points: 1000, className: "ring-[12px] ring-red-500 shadow-[0_0_48px_#f97316]" },
  { id: "frame-12", name: "Diamentowa", points: 1250, className: "ring-[13px] ring-cyan-100 shadow-[0_0_52px_#a5f3fc]" },
  { id: "frame-13", name: "Mistrzowska", points: 1500, className: "ring-[13px] ring-yellow-300 shadow-[0_0_55px_#fde047]" },
  { id: "frame-14", name: "Legendarna korona", points: 1800, className: "ring-[14px] ring-amber-300 shadow-[0_0_65px_#f59e0b]" },
] as const;
...
export function achievementPresentation(id: string) {
  const map: Record<string, { title: string; emoji: string; color: string }> = {
    ...
    "points-100": { title: "100 punktów", emoji: "🌅", color: "from-orange-400 to-fuchsia-600" },
    "points-500": { title: "500 punktów", emoji: "🪐", color: "from-indigo-600 to-violet-900" },
    "points-1500": { title: "Mistrz programu", emoji: "👑", color: "from-yellow-300 to-orange-600" },
