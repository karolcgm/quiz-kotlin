...
export const AGILE_GAME_TEMPLATES: AgileGameTemplate[] = [
  ...
  { id: "mars-mission", title: "Misja Mars", emoji: "🚀", description: "Zaprojektuj bazę na Marsie, dbając o energię, bezpieczeństwo i załogę.", mission: "Ustalcie najważniejszy element kolejnej wersji bazy i uzasadnijcie decyzję.", roles: ["Rzecznik załogi", "Koordynator misji", "Inżynier systemów", "Specjalista bezpieczeństwa"], cards: ["Moduł tlenu", "Panel energii", "Szklarnia", "Łazik", "Schron burzowy", "Łącze z Ziemią"], image: "/agile-games/mars-mission.png", finalImage: "/agile-games/mars-finale.png" },
  { id: "game-studio", title: "Studio Gier", emoji: "🎮", description: "Stwórzcie grę, do której chce się wracać — testując pomysły małymi krokami.", mission: "Wybierzcie funkcję gry na sprint i przygotujcie krótkie wyjaśnienie, dla kogo ją robicie.", roles: ["Rzecznik graczy", "Producent gry", "Projektant rozgrywki", "Tester jakości"], cards: ["Poziom startowy", "Bohater", "Zasada punktów", "Przeciwnik", "Muzyka", "Samouczek"], image: "/agile-games/game-studio.png", finalImage: "/agile-games/game-studio-finale.png" },
  { id: "future-city", title: "Miasto Przyszłości", emoji: "🏙️", description: "Zaprojektuj miasto wygodne dla mieszkańców, a nie tylko efektowne na plakacie.", mission: "Ustalcie, która potrzeba mieszkańców ma pierwszeństwo w tym sprincie.", roles: ["Rzecznik mieszkańców", "Koordynator miasta", "Projektant przestrzeni", "Specjalista dostępności"], cards: ["Park kieszonkowy", "Bezpieczne przejście", "Biblioteka", "Trasa rowerowa", "Punkt pomocy", "Zielony dach"], image: "/agile-games/future-city.png", finalImage: "/agile-games/future-city-finale.png" },
];
