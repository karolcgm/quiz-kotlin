...
const SENSE_TASKS: readonly DecimalEstimateSenseTask[] = [
  ...
  { expression: "7,2 : 0,6", proposedResult: "1,2", roundedExpression: "7,2 : 0,6 = 12", answer: false },
  { expression: "4,5 : 0,15", proposedResult: "30", roundedExpression: "4,5 : 0,15 = 30", answer: true },
