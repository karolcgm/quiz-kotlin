...
const PRACTICE_TASKS: readonly TaskData[] = [
  {
    ...
    operand: "3,45",
    exponent: 1,
    prompt: "Oblicz 3,45 × 10. Wyjaśnij zmianę, nazywając nowe wartości pozycyjne cyfr.",
  },
  {
    questionKind: "result",
    operand: "0,08",
    exponent: 3,
    prompt: "Oblicz 0,08 × 1000. Zapisz wszystkie zera potrzebne do utworzenia nowych miejsc.",
  },
  {
    questionKind: "result",
    operand: "2,5",
    exponent: 2,
    prompt: "Oblicz 2,5 × 100 i sprawdź, czy wynik jest sto razy większy.",
  },
  {
    questionKind: "missing-factor",
    operand: "0,34",
    exponent: 2,
    shownProduct: "34",
    prompt: "Uzupełnij brakujący czynnik: 0,34 × □ = 34.",
  },
  {
    questionKind: "unit-conversion",
    operand: "1,2",
    exponent: 3,
    sourceUnit: "m",
    requiredUnit: "mm",
    prompt: "Mata ma długość 1,2 m. Ile to milimetrów? Użyj zależności 1 m = 1000 mm.",
  },
] as const;
