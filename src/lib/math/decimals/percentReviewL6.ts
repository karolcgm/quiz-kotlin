...
const DIAGRAM_TASKS: readonly PercentReviewL6Task[] = [
  {
    ...
    fields: [
      { label: "Wszyscy uczniowie klasy 6A", unit: "osób", answer: 20, relationLabel: "100%" },
      { label: "Dziesięć procent klasy 6A", unit: "osoby", answer: 2, relationLabel: "10%" },
      { label: "Rowerzyści w 6A", unit: "osób", answer: 8, relationLabel: "40%" },
      { label: "Wszyscy uczniowie klasy 6B", unit: "osób", answer: 25, relationLabel: "100%" },
      { label: "Jeden procent klasy 6B", unit: "osoby", answer: 0.25, relationLabel: "1%" },
      { label: "Rowerzyści w 6B", unit: "osób", answer: 8, relationLabel: "32%" },
  ...
  },
  {
    ...
    fields: [
      { label: "Wszystkie osoby w grupie A", unit: "osób", answer: 30, relationLabel: "100%" },
      { label: "Dziesięć procent grupy A", unit: "osoby", answer: 3, relationLabel: "10%" },
      { label: "Autobus — grupa A", unit: "osób", answer: 9, relationLabel: "30%" },
      { label: "Wszystkie osoby w grupie B", unit: "osób", answer: 20, relationLabel: "100%" },
      { label: "Dziesięć procent grupy B", unit: "osoby", answer: 2, relationLabel: "10%" },
      { label: "Autobus — grupa B", unit: "osób", answer: 8, relationLabel: "40%" },
  ...
  },
  {
    ...
    fields: [
      { label: "Książki naukowe", unit: "%", answer: 15 },
      { label: "Poezja", unit: "%", answer: 10 },
      { label: "Naukowe i poezja razem", unit: "%", answer: 25, relationLabel: "15% + 10%" },
      { label: "Wszystkie książki", unit: "książek", answer: 160, relationLabel: "100%" },
      { label: "Jeden procent", unit: "książki", answer: 1.6, relationLabel: "1%" },
      { label: "Naukowe i poezja razem", unit: "książek", answer: 40, relationLabel: "25%" },
    ],
  },
  {
    ...
    fields: [
      { label: "Wszystkie punkty Fioletowych", unit: "punktów", answer: 80, relationLabel: "100%" },
      { label: "Dziesięć procent punktów Fioletowych", unit: "punktów", answer: 8, relationLabel: "10%" },
      { label: "Finał — Fioletowi", unit: "punktów", answer: 40, relationLabel: "50%" },
      { label: "Wszystkie punkty Turkusowych", unit: "punktów", answer: 120, relationLabel: "100%" },
      { label: "Dziesięć procent punktów Turkusowych", unit: "punktów", answer: 12, relationLabel: "10%" },
      { label: "Finał — Turkusowi", unit: "punktów", answer: 48, relationLabel: "40%" },
      { label: "Różnica w finale", unit: "punktów", answer: 8 },
    ],
  },
];
