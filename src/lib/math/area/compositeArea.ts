...
export const COMPOSITE_GRID_REVIEW_TASKS: CompositeAreaTask[] = [
  ...
  },
  {
    ...
    prompt: "Podziel zygzakowatą figurę pionowymi odcinkami na trzy prostokąty. Zanim wpiszesz wynik, sprawdź pole każdej części.",
    ...
    parts: [
      { id: "a", label: "Pole A — lewy prostokąt", shape: "prostokąt", area: 18, marker: [2.5, 4] },
      { id: "b", label: "Pole B — środkowy prostokąt", shape: "prostokąt", area: 8, marker: [5, 2] },
      { id: "c", label: "Pole C — prawy prostokąt", shape: "prostokąt", area: 6, marker: [7.5, 4] },
    ],
    total: 32,
    hint: "Pierwszy pionowy odcinek poprowadź od górnej krawędzi do dolnego wklęsłego narożnika. Drugi poprowadź od górnego wklęsłego narożnika do dolnej krawędzi środkowej części.",
    success: `18 ${cm2} + 8 ${cm2} + 6 ${cm2} = 32 ${cm2}.`,
  },
  {
