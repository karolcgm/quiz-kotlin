...
export const COMPOSITE_GRID_REVIEW_TASKS: CompositeAreaTask[] = [
  {
    id: "trapezoid-triangle-review",
    prompt: "Podziel figurę na trapez i trójkąt. Odczytaj z kratownicy długości podstaw oraz wysokości, a następnie oblicz pole całej figury.",
    polygon: [[1, 7], [3, 4], [5, 1], [7, 4], [9, 7]],
    cuts: [{ from: [3, 4], to: [7, 4] }],
    parts: [
      { id: "a", label: "Pole A — trójkąt", shape: "trójkąt", area: 6, marker: [5, 2.7] },
      { id: "b", label: "Pole B — trapez", shape: "trapez", area: 18, marker: [5, 5.7] },
    ],
    total: 24,
    hint: "Połącz dwa boczne wierzchołki leżące na tej samej poziomej linii. Nad odcinkiem powstanie trójkąt, a pod nim trapez.",
    success: `6 ${cm2} + 18 ${cm2} = 24 ${cm2}.`,
  },
  {
    id: "trapezoid-parallelogram-review",
    prompt: "Podziel figurę na trapez i równoległobok. Odczytaj ich podstawy i wysokości z kratownicy, a następnie zsumuj pola.",
    polygon: [[2, 7], [7, 7], [6, 4], [5, 1], [3, 1], [1, 4]],
    cuts: [{ from: [1, 4], to: [6, 4] }],
    parts: [
      { id: "a", label: "Pole A — trapez", shape: "trapez", area: 10.5, marker: [3.8, 2.7] },
      { id: "b", label: "Pole B — równoległobok", shape: "równoległobok", area: 15, marker: [4, 5.6] },
    ],
    total: 25.5,
    hint: "Połącz dwa wierzchołki na wysokości 4 kratek. Górna część jest trapezem, a dolna równoległobokiem.",
    success: `10,5 ${cm2} + 15 ${cm2} = 25,5 ${cm2}.`,
  },
  {
  ...
  {
    id: "two-triangles-review",
    prompt: "Podziel deltoid na dwa trójkąty. Odczytaj z kratownicy wspólną podstawę i wysokość każdego trójkąta, a następnie oblicz pole całej figury.",
    polygon: [[5, 1], [9, 4], [5, 7], [1, 4]],
    cuts: [{ from: [1, 4], to: [9, 4] }],
    parts: [
      { id: "a", label: "Pole A — górny trójkąt", shape: "trójkąt", area: 12, marker: [5, 2.8] },
      { id: "b", label: "Pole B — dolny trójkąt", shape: "trójkąt", area: 12, marker: [5, 5.2] },
    ],
    total: 24,
    hint: "Połącz lewy i prawy wierzchołek. Odcinek będzie wspólną podstawą obu trójkątów.",
    success: `12 ${cm2} + 12 ${cm2} = 24 ${cm2}.`,
  },
];
