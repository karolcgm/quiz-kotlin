...
const choices: Record<Exclude<AlgebraActivity, "meet-x" | "same-x" | "write-story-expression" | "substitution-machine" | "equation-meaning" | "solution-meaning" | "candidate-substitution" | "equation-solving-rules" | "solve-with-balance" | "solve-equation-steps" | "scale-to-equation" | "equation-to-scale" | "write-basic-equation" | "write-story-equation" | "balance-solve" | "inverse-operation" | "evaluate-expression" | "write-substitution" | "simplify-expression" | "simplify-multiply-divide" | "simplify-mixed" | "story-solve" | "story-workflow-intro" | "story-workflow" | "review-write" | "review-evaluate" | "review-simplify" | "review-solve-equation" | "review-story">, AlgebraChoiceTask[]> = {
  ...
  "like-terms": [
    ...
    { id: "l3", kind: "choice", prompt: "Uprość wyrażenie 2x + 3. Który wynik jest poprawny?", options: ["2x + 3", "5x", "5", "6x"], answer: "2x + 3", explanation: "Wyrazu 2x nie można połączyć z liczbą 3. To dwa różne rodzaje składników, dlatego zapis pozostaje bez zmian: 2x + 3.", visual: "like-terms" },
...
const interactiveBalanceSolveTasks: AlgebraInteractiveBalanceSolveTask[] = [
  ...
  { id: "wb5", kind: "interactive-balance-solve", prompt: "Rozwiąż równanie x − 4 = 7 za pomocą wagi.", expression: "x − 4 = 7", answer: 11, explanation: "Do obu stron dodajemy 4. Ujemny żeton −4 tworzy z dodatnim żetonem 4 parę zerową i znika. Na wadze zostaje x = 11.", visual: "balance-equation", leftX: 1, leftUnits: -4, rightUnits: 7 },
  { id: "wb6", kind: "interactive-balance-solve", prompt: "Rozwiąż równanie x − 6 = 5 za pomocą wagi.", expression: "x − 6 = 5", answer: 11, explanation: "Do obu stron dodajemy 6. Na lewej szalce liczby −6 i 6 znikają, a na wadze zostaje x = 11.", visual: "balance-equation", leftX: 1, leftUnits: -6, rightUnits: 5 },
  { id: "wb7", kind: "interactive-balance-solve", prompt: "Rozwiąż równanie x/2 = 5 za pomocą wagi.", expression: "x/2 = 5", answer: 10, explanation: "Obie strony mnożymy przez 2. Połówka x zmienia się w całe x, a na drugiej szalce otrzymujemy 10.", visual: "balance-equation", leftX: 1 / 2, rightUnits: 5 },
  { id: "wb8", kind: "interactive-balance-solve", prompt: "Rozwiąż równanie x/3 = 4 za pomocą wagi.", expression: "x/3 = 4", answer: 12, explanation: "Obie strony mnożymy przez 3. Jedna trzecia x zmienia się w całe x, a na drugiej szalce otrzymujemy 12.", visual: "balance-equation", leftX: 1 / 3, rightUnits: 4 },
];
