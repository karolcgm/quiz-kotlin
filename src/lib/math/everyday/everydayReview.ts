...
export const EVERYDAY_REVIEW_DATA: EverydayReviewTask[] = [
  ...
  { id: "bars-difference", title: "Porównanie wyników drużyn", prompt: "W trzeciej rundzie Niebiescy zdobyli więcej punktów niż Zieloni. O ile punktów więcej zdobyli?", answer: "7", answerLabel: "7 punktów", unit: "punktów", hint: "Porównaj wyniki obu drużyn w trzeciej rundzie.", visual: { kind: "bars", title: "Punkty w turnieju", labels: ["Runda 1", "Runda 2", "Runda 3", "Runda 4"], first: [18, 26, 31, 24], second: [20, 21, 24, 29], legends: ["Niebiescy", "Zieloni"] } },
