...
export const m515NajpierwPrzewidzV1: LessonPackage = {
  ...
  teacherGuide: { overview: "Podręcznik, 11 zadań na trzech slajdach i końcowa ocena umiejętności.", timingNotes: "45 minut: 8 + 10 + 10 + 10 + 7.", materials: ["Tablica", "Tablety lub zeszyty"], stageNotes: { "m5-1-5-book": "Ustaw stronę i zadanie dla całej klasy.", "m5-1-5-actions": "Pięć różnych działań: dodawanie, odejmowanie, mnożenie, dzielenie i kolejność działań.", "m5-1-5-shop": "Trzy różne pytania TAK/NIE o zakupach i produktach.", "m5-1-5-story": "Trzy różne zadania z życia; przypomnij o zaokrąglaniu i porównywaniu.", "m5-1-5-understanding": "Uczniowie kończą lekcję oceną własnego rozumienia." }, commonMisconceptions: ["Dokładne liczenie zamiast szacowania."], differentiation: { support: "Pozwól zapisać zaokrąglenia obok liczb.", core: "Wykonaj wszystkie 11 zadań.", challenge: "Uzasadnij, dlaczego szacunek ma sens." }, openingScript: "Dziś nie liczymy dokładnie — najpierw sprawdzamy, jakiego wyniku się spodziewamy.", closingScript: "Dobry szacunek pozwala szybko sprawdzić, czy wynik ma sens.", exitTicketRubric: "11 odpowiedzi i ocena umiejętności.", paperWithoutDevices: "Uczniowie zaznaczają wynik na karcie ABC lub TAK/NIE.", languageReview: "szacunek, zaokrąglenie, pełne setki" },
  stages: [
