...
export const m519DetektywDanychV1: LessonPackage = buildLessonPackage({
  ...
  estimatedMinutes: 50,
  overview:
    "Cztery konkretne zadania tekstowe: rozwiązanie prowadzone, wybór danych, zadanie dwuetapowe i zadanie samodzielne.",
  openingScript:
  ...
  stageBlueprints: [
    {
      suffix: "guided",
      kind: "explore",
      title: "Zadanie 1 — rozwiązanie prowadzone",
      minutes: 11,
      headline: "Czego szukamy, jakie mamy dane i jak obliczymy wynik?",
      body: "Przejdź po kolei przez pytanie, potrzebne dane, obliczenia i odpowiedź. Pola obliczeń oraz wyniku pozostają puste do samodzielnego uzupełnienia.",
      modelId: "written-story-problems-lesson",
      modelSeed: 1,
      questions: lessonQuestions("m5-1-9", 1, 1, "written-story-problems-v1"),
      studentInstruction:
        "Wykonaj pięć kroków pokazanych na planszy. Wpisz własne obliczenia i odpowiedź.",
    },
    {
      suffix: "choose-data",
      kind: "practice",
      title: "Zadanie 2 — wybierz potrzebne dane",
      minutes: 11,
      headline: "Jedna informacja nie jest potrzebna",
      body: "Najpierw zaznacz dane potrzebne do rozwiązania. Potem zapisz obliczenie i odpowiedź. Nie używaj liczby, która nie odpowiada na pytanie.",
      modelId: "written-story-problems-lesson",
      modelSeed: 2,
      questions: lessonQuestions("m5-1-9", 2, 1, "written-story-problems-v1"),
      studentInstruction:
        "Zaznacz potrzebne dane, wpisz obliczenie i odpowiedz pełnym zdaniem.",
    },
    {
      suffix: "two-step",
      kind: "practice",
      title: "Zadanie 3 — rozwiązanie dwuetapowe",
      minutes: 11,
      headline: "Zaplanuj dwa działania",
      body: "Ustal kolejność dwóch działań, zapisz oba obliczenia i dopiero wtedy podaj odpowiedź. Po poprawnym rozwiązaniu zobaczysz przykładowy plan.",
      modelId: "written-story-problems-lesson",
      modelSeed: 3,
      questions: lessonQuestions("m5-1-9", 3, 1, "written-story-problems-v1"),
      studentInstruction:
        "Samodzielnie zaplanuj dwa działania, wpisz obliczenia i odpowiedź.",
    },
    {
      suffix: "independent",
      kind: "challenge",
      title: "Zadanie 4 — praca samodzielna",
      minutes: 11,
      headline: "Rozwiąż bez podpowiedzi",
      body: "Przeczytaj zadanie, zostaw ślad obliczeń i wpisz odpowiedź. Etapy rozwiązania nie są podane przed wysłaniem.",
      modelId: "written-story-problems-lesson",
      modelSeed: 4,
      questions: lessonQuestions("m5-1-9", 4, 1, "written-story-problems-v1"),
      studentInstruction:
        "Rozwiąż zadanie samodzielnie. Wpisz obliczenia i odpowiedź.",
    },
  ],
});
