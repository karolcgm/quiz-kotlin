...
export const m514KolejnoscDzialanV1: LessonPackage = {
  ...
  stages: [
    ...
    createLessonStage({ id: "m5-1-4-result", kind: "exit-ticket", title: "Oblicz wynik", studentInstruction: "Zastosuj kolejność działań i wpisz wynik.", teacherInstruction: "Dwa zadania po kolei. Panel nauczyciela pokaże wysłane odpowiedzi.", estimatedMinutes: 13, live: { enabled: true, kind: "exercise", minutes: 13 }, board: { layout: "model", headline: "Wartość wyrażenia", modelId: "order-of-operations-lesson", modelSeed: 3 }, student: { activityMode: "respond", instruction: "Oblicz i wyślij dwa wyniki.", modelId: "order-of-operations-lesson", modelSeed: 3 } }, questions(3, 2)),
  ],
};
