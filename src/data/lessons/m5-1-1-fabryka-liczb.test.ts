...
describe("lekcja M5-1.1", () => {
  it("ma slajd podręcznika i pięć serii po trzy zadania", () => {
    expect(m511FabrykaLiczbV1.stages).toHaveLength(6);
    expect(m511FabrykaLiczbV1.stages.map((stage) => stage.questions.length)).toEqual([0, 3, 3, 3, 3, 3]);
