...
export const m544SkrzyzowanieProstychV1 = s4({
  ...
  stages: [
    ...
    },
    {
      suffix: "s5",
      kind: "practice",
      title: "Obliczenia z rysunku",
      minutes: 9,
      headline: "Oblicz wskazane kąty na kilku różnych rysunkach.",
      body: "Każde zadanie ma inny układ prostych, jak na przesłanej karcie. Uczeń sam rozpoznaje, czy korzysta z równości kątów wierzchołkowych, czy z sumy 180° kątów przyległych.",
      modelId: "geometry-lab",
      modelSeed: 440501,
      studentInstruction: "Wpisz dwie miary i wybierz własność używaną w każdym obliczeniu. Po zatwierdzeniu przejdź do następnego rysunku.",
      ...
      print: {
        worksheetTitle: "Obliczenia z rysunku",
