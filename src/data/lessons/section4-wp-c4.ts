  ...
  return [
    {
      ...
      modelId: "geometry-lab",
      modelSeed: seeds.theory,
      studentInstruction: "Obejrzyj obie figury, przeczytaj ich własności i rozwiąż kolejno trzy zadania. Na rysunku kątów nie ma stałych miar — α i β mogą się zmieniać, ale zawsze α + β = 180°.",
    },
    {
      suffix: "diagonals",
      kind: "worked-example",
    ...
    },
    {
      ...
      print: {
        ...
        items: [
          ...
          { id: "parallelogram-rhombus-print-3", skillIds: ["M5-4.10-parallelogram-rhombus"], maxScore: 1, expression: "Romb: a = 6 cm", prompt: "Oblicz obwód." },
          { id: "parallelogram-rhombus-print-4", skillIds: ["M5-4.10-parallelogram-rhombus"], maxScore: 2, expression: "Równoległobok: P = 28 cm, a = 4½ cm", prompt: "Oblicz drugi bok." },
          { id: "parallelogram-rhombus-print-5", skillIds: ["M5-4.10-parallelogram-rhombus"], maxScore: 1, expression: "Romb: P = 34 cm", prompt: "Oblicz długość boku i zapisz ją jako liczbę mieszaną." },
        ],
      },
    },
  ];
