...
export const m541ProsteRelacjeL1V1 = s4({
  ...
  coreLesson: "Miasto linii",
  paperEvidence: "Karta L1 z parami prostych w położeniu poziomym, pionowym i ukośnym",
  studentGoal: "Uczeń rozpoznaje relacje prostych niezależnie od ich położenia i zapisuje równoległość oraz prostopadłość symbolami.",
  successCriteria: [
    "Rozpoznaje proste równoległe i zapisuje a ∥ b.",
    "Rozpoznaje proste prostopadłe i zapisuje a ⟂ b.",
    "Odróżnia proste przecinające i współliniowe.",
    "Wskazuje kąt prosty kwadratem, a relację kolorem i symbolem.",
  ],
  prerequisiteSkillIds: [],
  skillIds: ["M5-4.1-parallel-perpendicular"],
  estimatedMinutes: 45,
  overview: "L1 — rozpoznawanie relacji prostych w czasie rzeczywistym, bez konstrukcji i użycia ekierki.",
  openingScript: "„Dziś sprawdzamy relację po kierunku i kącie, a nie po tym, czy rysunek stoi prosto.”",
  closingScript: "„Nazwij relację, zapisz ∥ albo ⟂ i wskaż dowód na rysunku.”",
  commonMisconceptions: [
    ...
    "Mylenie prostych współliniowych z dwiema różnymi prostymi równoległymi.",
  ],
  stages: [
    {
      suffix: "s1",
      kind: "warmup",
      title: "Wejście — cztery relacje",
      minutes: 4,
      headline: "Które drogi się nie spotkają, które tworzą 90°, a które leżą na tej samej prostej?",
      body: "Najpierw nazwij relację własnymi słowami. Kolor jest tylko pomocą — odpowiedź zawsze uzupełnij symbolem lub opisem.",
      print: {
        worksheetTitle: "Proste prostopadłe i równoległe — L1",
        instructions: "Przy każdej parze wpisz: równoległe, prostopadłe, przecinające albo współliniowe.",
        items: [
          { id: "warmup-horizontal", expression: "a: ─────────   b: ───────── (na różnych wysokościach)", prompt: "Nazwij relację i dopisz symbol, jeśli istnieje." },
        ],
      },
    },
    {
      ...
      title: "Miasto linii",
      minutes: 10,
      headline: "Miasto linii — przesuń i obróć drogę b",
      body: "Klasyfikacja zmienia się w tej samej chwili co położenie drogi. Dla kąta 90° pojawia się kwadrat; ∥ i ⟂ są widoczne razem z nazwą, nie samym kolorem.",
      modelId: "geometry-lab",
      modelSeed: 410201,
      studentInstruction: "Przesuwaj i obracaj drogę b. Znajdź po jednym przykładzie relacji: ∥, ⟂, przecinające i współliniowe.",
      teacherInstruction: "Zatrzymuj model przed wartościami granicznymi. Przy błędnej próbie równoległości lub prostopadłości omów odpowiednio GEO_NOT_PARALLEL albo GEO_NOT_PERPENDICULAR.",
      print: {
        worksheetTitle: "Miasto linii — obserwacje",
        instructions: "Narysuj strzałkę od zmiany położenia do nowej klasyfikacji. Nie wykonuj konstrukcji.",
        items: [
          { id: "city-observation", expression: "obrót b: 0° → 90° względem a", prompt: "Zapisz, kiedy pojawia się a ∥ b, a kiedy a ⟂ b." },
        ],
      },
    },
    {
      suffix: "s3",
      kind: "discuss",
      title: "Nie ufaj położeniu",
      minutes: 7,
      headline: "Nie ufaj położeniu — poziome, pionowe i ukośne",
      body: "Obróć cały układ przy zachowaniu relacji. Nazwa nie zależy od ustawienia kartki: ukośne proste także mogą być równoległe albo prostopadłe.",
      modelId: "geometry-lab",
      modelSeed: 410101,
      studentInstruction: "Wybierz kolejno: Poziome, Pionowe i Ukośne. Za każdym razem odczytaj nazwę, symbol oraz tabelę stanu.",
      discussionPrompts: [
        "Co pozostaje niezmienne po obrocie całego układu?",
        "Dlaczego dwie proste ukośne mogą być prostopadłe?",
        "Czym proste współliniowe różnią się od dwóch różnych prostych równoległych?",
      ],
      print: {
        worksheetTitle: "Nie ufaj położeniu",
        instructions: "Każdą relację sprawdź w innym położeniu. Użyj nazwy i symbolu.",
        items: [
          { id: "orientation-horizontal", expression: "dwie proste poziome na różnych wysokościach", prompt: "Zapisz relację." },
          { id: "orientation-vertical", expression: "prosta pionowa i pozioma z jednym punktem wspólnym", prompt: "Zapisz relację i zaznacz kąt prosty." },
          { id: "orientation-diagonal", expression: "dwie ukośne proste o tym samym kierunku", prompt: "Zapisz relację." },
        ],
      },
    },
    {
      suffix: "s4",
      kind: "worked-example",
      title: "Cztery możliwe relacje",
      minutes: 7,
      headline: "Równoległe, prostopadłe, przecinające czy współliniowe?",
      body: "Najpierw porównaj kierunki. Potem sprawdź liczbę punktów wspólnych i kąt: brak wspólnego punktu oznacza ∥, kąt 90° oznacza ⟂, jeden inny kąt — przecięcie, a wszystkie wspólne punkty — współliniowość.",
      modelId: "geometry-lab",
      modelSeed: 410201,
      studentInstruction: "Przełącz cztery przykłady relacji. Wskaż symbol i cechę, która potwierdza każdą nazwę.",
      print: {
        worksheetTitle: "Algorytm rozpoznawania",
        instructions: "Uzupełnij cechę rozstrzygającą.",
        items: [
          { id: "four-relations", expression: "∥ / ⟂ / × / ≡", prompt: "Do każdego symbolu dopisz liczbę punktów wspólnych lub miarę kąta, która rozstrzyga." },
        ],
      },
    },
    {
      ...
      modelId: "geometry-lab",
      modelSeed: 410301,
      studentInstruction: "Rozwiąż kolejno trzy poziomy. Wybierz jedną z czterech relacji i sprawdź feedback z symbolem oraz wskazanym miejscem.",
      teacherInstruction: "Nie nazywaj poziomów łatwy/trudny. Błędny wybór ∥ uruchamia GEO_NOT_PARALLEL, a błędny wybór ⟂ — GEO_NOT_PERPENDICULAR.",
      print: {
    ...
    },
    {
      ...
      minutes: 4,
      headline: "Samodzielna próba — jedna klasyfikacja i jeden dowód",
      ...
      print: {
        ...
        items: [
          { id: "exit-relation", maxScore: 2, expression: "a: ╱   b: ╱, obie leżą dokładnie na tym samym śladzie", prompt: "Nazwij relację. Wyjaśnij, dlaczego nie są to dwie różne proste równoległe." },
        ],
      },
    },
  ],
...
export const m542RozchylRamionaV1 = s4({
  ...
  learningGoals: [
    {
      id: "m5-4-2-goal-1",
      studentGoal: "Nauczę się wskazywać wierzchołek, ramiona i łuk kąta.",
      successCriteria: ["Potrafię wskazać wspólny wierzchołek, oba ramiona i łuk oznaczający rozchylenie kąta."],
    ...
    {
      id: "m5-4-2-goal-3",
      studentGoal: "Nauczę się porównywać kąty bez sugerowania się długością ramion.",
      successCriteria: ["Potrafię porównać kąty po rozchyleniu i wyjaśnić, dlaczego długość ramion nie zmienia miary kąta."],
  ...
  estimatedMinutes: 45,
  overview: "L1 — kąt jako rozchylenie dwóch ramion: przewidywanie przed ujawnieniem nazwy, elementy kąta, niezmienniczość przy obrocie i zmianie długości ramion oraz dokładne bramki 90° i 180°.",
  openingScript: "„Najpierw rozchyl ramiona i przewidź nazwę. Miara oraz rodzaj pojawią się dopiero po Twojej decyzji.”",
  closingScript: "„Kąt opisuje rozchylenie ramion: obrót całej figury i wydłużenie ramienia nie zmieniają jego miary.”",
  commonMisconceptions: [
    "Uznawanie 89° lub 91° za kąt prosty, bo rysunek wygląda prawie jak 90°.",
    "Uznawanie kąta z dłuższymi ramionami za większy.",
    "Klasyfikowanie kąta na podstawie obrotu całej figury na ekranie.",
    "Mylenie wierzchołka z punktem na końcu ramienia albo łuku z ramieniem.",
  ],
  stages: [
    {
      suffix: "s1",
      kind: "warmup",
      title: "Zanim nazwiesz",
      minutes: 3,
      headline: "Co opisuje kąt: długość kresek, kierunek na ekranie czy rozchylenie ramion?",
      body: "Pokaż gestem dwa ramiona o wspólnym początku. Obróć cały gest i sprawdź, co się zmieniło, a co pozostało stałe.",
      studentInstruction: "Ułóż dwa ramiona ze wspólnym początkiem, obróć całą figurę i nazwij wielkość, która się nie zmieniła.",
      teacherInstruction: "Nie podawaj jeszcze nazw rodzajów. Zbieraj przewidywania i zaznacz, że orientacja rysunku nie rozstrzyga klasyfikacji.",
      print: {
        worksheetTitle: "Kąty i ich rodzaje — Zanim nazwiesz",
        instructions: "Dorysuj drugie ramię do punktu B. Zaznacz wspólny początek i łuk rozchylenia.",
        items: [{ id: "warmup-gesture", expression: "A ⟵ B     ?", prompt: "Dorysuj ramię BC i zaznacz łuk; nie wpisuj jeszcze rodzaju kąta." }],
      },
    },
    {
      suffix: "s2",
      kind: "predict",
      title: "Rozchyl ramiona",
      minutes: 7,
      headline: "Najpierw przewidź rodzaj kąta, dopiero potem odsłoń nazwę i miarę.",
      body: "Przeciągnij ramię BC, użyj klawiatury albo wpisz liczbę. Wybierz przewidywanie przed ujawnieniem klasyfikacji; po każdej zmianie wykonaj nowe przewidywanie.",
      modelId: "geometry-lab",
      modelSeed: 420101,
      studentInstruction: "Rozchyl ramię, przewidź: ostry, prosty, rozwarty lub półpełny, a potem sprawdź klasyfikację.",
      teacherInstruction: "Pilnuj kolejności przewidywanie → ujawnienie. Obserwuj ANGLE_EMPTY_PREDICTION i ANGLE_TYPE_MISCLASSIFIED; rozwiązanie pokazuj dopiero po odpowiedzi.",
      discussionPrompts: ["Co zobaczyłeś przed ujawnieniem nazwy?", "Czy obrót całej figury mógłby zmienić Twoją odpowiedź?"],
      print: {
        worksheetTitle: "Rozchyl ramiona — przewidź przed nazwą",
        instructions: "Przy każdym rysunku najpierw wpisz przewidywanie, potem porównaj z 90° i 180°.",
        items: [
          { id: "predict-acute", expression: "∠ABC = 45°", prompt: "Przewidywanie: ______. Uzasadnienie względem 90°: ______." },
          { id: "predict-near", expression: "∠DEF = 89°", prompt: "Przewidywanie: ______. Czy to już kąt prosty? ______." },
        ],
      },
    },
    {
      ...
      title: "Co tworzy kąt?",
      minutes: 5,
      headline: "Umieść etykiety: wierzchołek, ramię i łuk.",
      body: "Wybierz etykietę, a następnie wskaż pasujący cel na modelu. ● oznacza wierzchołek, → kierunek ramienia, a ⌒ łuk rozchylenia; ∠ABC ma wierzchołek B.",
      modelId: "geometry-lab",
      modelSeed: 420201,
      studentInstruction: "Połącz etykiety z elementami przez wybierz → umieść. Możesz użyć dotyku albo klawiatury Enter/Spacja.",
      teacherInstruction: "W błędzie ANGLE_LABEL_NOT_SELECTED lub ANGLE_ELEMENT_MISPLACED poproś o wskazanie wspólnego początku, półprostej i zakrzywionego znacznika.",
      discussionPrompts: ["Dlaczego w zapisie ∠ABC litera B jest w środku?", "Czy łuk jest ramieniem kąta, czy tylko oznaczeniem rozchylenia?"],
      print: {
        worksheetTitle: "Co tworzy kąt?",
        instructions: "Podpisz model słowami: wierzchołek, ramię, łuk. Użyj także symboli ●, → i ⌒.",
        items: [{ id: "elements-abc", expression: "∠ABC", prompt: "Otocz wierzchołek B, podkreśl nazwy ramion BA i BC oraz dorysuj łuk." }],
      },
    },
    {
      suffix: "s4",
      ...
      modelId: "geometry-lab",
      modelSeed: 420301,
      studentInstruction: "Zmień długości obu ramion i wybierz, który kąt jest większy. Uzasadnij odpowiedź nałożeniem łuków.",
      teacherInstruction: "Dla ANGLE_LENGTH_BIAS włącz nałożenie krótszego modelu i poproś o porównanie kierunków ramion przy wspólnym wierzchołku.",
      print: {
        worksheetTitle: "Długie ramię nie znaczy większy kąt",
        instructions: "Porównaj rozchylenie, a nie długości narysowanych odcinków.",
        items: [{ id: "length-invariant", expression: "Dwa kąty po 55°; pierwszy ma ramiona 4 cm i 5 cm, drugi 8 cm i 10 cm.", prompt: "Wstaw <, = albo > między kątami i wyjaśnij nałożeniem." }],
      },
    },
    {
      suffix: "s5",
      ...
      modelId: "geometry-lab",
      modelSeed: 420401,
      studentInstruction: "Użyj czterech bramek. Odczytaj klasyfikację w czasie rzeczywistym i sprawdź znak kwadratu przy 90°.",
      teacherInstruction: "Porównaj 89°–90°–91° bez kategorii „prawie prosty”. Potem ustaw 180° jako dokładną bramkę kąta półpełnego.",
      discussionPrompts: ["Dlaczego 89° jest ostre, choć wygląda prawie jak prosty?", "Co dokładnie zmienia się między 90° a 91°?"],
      print: {
        worksheetTitle: "Bramki 90° i 180°",
        instructions: "Wpisz rodzaj każdego kąta. Zakreśl jedyną miarę, przy której rysujemy kwadrat kąta prostego.",
        items: [
          { id: "gate-89", expression: "89°", prompt: "Rodzaj: ______." },
          { id: "gate-90", expression: "90°", prompt: "Rodzaj i znak: ______." },
          { id: "gate-91", expression: "91°", prompt: "Rodzaj: ______." },
          { id: "gate-180", expression: "180°", prompt: "Rodzaj: ______." },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      modelId: "geometry-lab",
      modelSeed: 420501,
      studentInstruction: "Przejdź trzy sytuacje. Ustaw wymagany rodzaj dotykiem, klawiaturą lub liczbą i naciśnij „Sprawdź reflektor”.",
      teacherInstruction: "W ANGLE_TARGET_NOT_REACHED kieruj do wymaganej granicy, nie podawaj gotowej miary. W ANGLE_INTERFACE_INPUT przypomnij zakres pola i zachowaj poprzedni stan.",
      print: {
        worksheetTitle: "Reflektory sceniczne — trzy sytuacje",
        instructions: "Dobierz przykładową miarę i nazwij rodzaj kąta. Dla narożnika podaj wartość dokładną.",
        items: [
          { id: "spotlight-narrow", expression: "1. Wąski snop", prompt: "Miara: ___°, rodzaj: ______." },
          { id: "spotlight-corner", expression: "2. Narożnik sceny", prompt: "Dokładna miara: ___°, rodzaj: ______." },
          { id: "spotlight-curtain", expression: "3. Szeroka kurtyna", prompt: "Miara: ___°, rodzaj: ______." },
        ],
      },
    },
    {
