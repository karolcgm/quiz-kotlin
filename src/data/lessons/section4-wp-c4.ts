...
export const m542RozchylRamionaV1 = s4({
  ...
  studentGoal: "Uczeń wskazuje wierzchołek, ramiona i wnętrze kąta, poprawnie zapisuje jego nazwę oraz rozpoznaje rodzaje kątów po rozwartości, mierze i położeniu na figurze.",
  successCriteria: [
    "Potrafię wskazać wierzchołek, oba ramiona i wnętrze kąta.",
  ...
  estimatedMinutes: 45,
  overview: "L1 — budowa i zapis kąta, greckie oznaczenia, pełna klasyfikacja od 0° do 360°, rozpoznawanie po mierze, kolorowanie rodzajów i wskazywanie kątów na figurze.",
  ...
  stages: [
    ...
    },
    {
      ...
      minutes: 5,
      headline: "Zakwalifikuj każdą miarę do właściwego rodzaju kąta",
      body: "Uczeń klasyfikuje miary od 0° do 360°. Każdy przykład pozostaje widoczny, a poprawna nazwa pojawia się dopiero po decyzji.",
      modelId: "geometry-lab",
      modelSeed: 421501,
      studentInstruction: "Wybierz kartę z miarą, a następnie nazwę kąta. Rozwiąż wszystkie osiem przykładów.",
      teacherInstruction: "Wymagaj samodzielnej decyzji na podstawie przedziałów. Nie uruchamiaj mierzenia kątomierzem — miara jest już podana.",
      discussionPrompts: ["Dlaczego 180° nie jest kątem rozwartym?", "Czym różni się 216° od 136°?"],
      print: {
        worksheetTitle: "Klasyfikacja kątów po mierze",
        instructions: "Przy każdej mierze wpisz dokładną nazwę rodzaju kąta.",
        items: [
          { id: "measure-set-a", expression: "36°, 90°, 136°, 180°", prompt: "Nazwy: ________________________________." },
          { id: "measure-set-b", expression: "216°, 283°, 360°", prompt: "Nazwy: ________________________________." },
        ],
      },
    },
    {
      ...
      minutes: 5,
      headline: "Każdy poprawnie rozpoznany rodzaj otrzymuje własny kolor",
      body: "Na wzór planszy z przesłanego materiału uczeń wybiera kolejno rysunki kątów i przypisuje im rodzaj. Pole kąta zostaje pokolorowane dopiero po poprawnej odpowiedzi.",
      modelId: "geometry-lab",
      modelSeed: 421601,
      studentInstruction: "Wybierz rysunek kąta, nazwij jego rodzaj i pokoloruj w ten sposób całą planszę.",
      ...
      print: {
        ...
        items: [
          { id: "color-angles-a", skillIds: ["M5-4.2-angle-types"], expression: "Rysunki: 35°, 90°, 125°", prompt: "Nazwij i pokoloruj każdy kąt zgodnie z legendą." },
          { id: "color-angles-b", skillIds: ["M5-4.2-angle-types"], expression: "Rysunki: 180°, 235°, 360°", prompt: "Nazwij i pokoloruj każdy kąt zgodnie z legendą." },
        ],
      },
    },
    {
      ...
      minutes: 4,
      headline: "Kąt figury znajduje się przy wierzchołku między dwoma bokami",
      body: "Uczeń wskazuje wszystkie kąty wewnętrzne czworokąta. Każde zaznaczenie pozostaje widoczne, aby można było sprawdzić kompletność odpowiedzi.",
      modelId: "geometry-lab",
      modelSeed: 421701,
      studentInstruction: "Kliknij wszystkie wierzchołki, przy których znajdują się kąty wewnętrzne figury.",
      teacherInstruction: "Po wskazaniu poproś ucznia o opis: dwa boki spotykają się w jednym wierzchołku i wyznaczają kąt figury.",
      print: {
        worksheetTitle: "Kąty na figurach",
        instructions: "Zaznacz łukiem każdy kąt wewnętrzny i zapisz jego trzyliterową nazwę.",
        items: [
          { id: "figure-quadrilateral", expression: "Czworokąt ABCD", prompt: "Zaznacz cztery kąty wewnętrzne i zapisz ich nazwy." },
          { id: "figure-triangle", expression: "Trójkąt KLM", prompt: "Zaznacz trzy kąty wewnętrzne i zapisz ich nazwy." },
        ],
      },
    },
    {
      suffix: "s7",
      kind: "exit-ticket",
      title: "Samodzielne rozpoznawanie kątów",
      minutes: 3,
      headline: "Nazwij cztery kąty bez podpowiedzi",
      body: "Uczeń rozpoznaje kąty 72°, 90°, 180° i 305° na rysunkach. To końcowy dowód przed Oceną umiejętności.",
      modelId: "geometry-lab",
      modelSeed: 421801,
      studentInstruction: "Rozwiąż cztery przykłady po kolei. W każdym wybierz dokładną nazwę rodzaju kąta.",
      ...
      print: {
        worksheetTitle: "Samodzielne rozpoznawanie kątów",
        instructions: "Rozwiąż samodzielnie. Nazwij rodzaj, podaj oznaczenie greckie i poprawny zapis trzyliterowy.",
        items: [
          { id: "independent-support", skillIds: ["M5-4.2-angle-types"], maxScore: 1, expression: "∠ABC = 72°", prompt: "Nazwij rodzaj kąta i podkreśl literę wierzchołka." },
          { id: "independent-core", skillIds: ["M5-4.2-angle-types"], maxScore: 2, expression: "β = 180°", prompt: "Nazwij rodzaj kąta i zdecyduj, czy jest wypukły." },
          { id: "independent-challenge", skillIds: ["M5-4.2-angle-types"], maxScore: 2, expression: "γ = 305°", prompt: "Nazwij rodzaj kąta i zapisz właściwy przedział miary." },
        ],
      },
    },
  ],
