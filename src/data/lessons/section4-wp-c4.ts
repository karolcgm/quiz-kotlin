...
export const m543KatomierzEkranowyV1 = s4({
  ...
  estimatedMinutes: 45,
  overview: "L1 — pomiar kąta wirtualnym kątomierzem oraz zastosowanie miar kątów w zadaniu z kątem wklęsłym i obrotem wskazówki minutowej. Rysowanie kątów należy do osobnego L2.",
  ...
  stages: [
    ...
    },
    {
      ...
      minutes: 8,
      headline: "Zmierz kąt za pomocą wirtualnego kątomierza.",
      body: "Ustaw kątomierz na rysunku, odczytaj miarę kąta i wpisz ją w puste kratki.",
      modelId: "geometry-lab",
      modelSeed: 430101,
      studentInstruction: "Przesuń środek kątomierza na B, ustaw prostą krawędź na ramieniu BA, odczytaj miarę i wpisz ją za pomocą klawiatury liczbowej.",
      teacherInstruction: "Uczeń sam ustawia wirtualny kątomierz i zatwierdza odpowiedź dopiero po uzupełnieniu wszystkich kratek.",
      discussionPrompts: ["Od którego zera należy rozpocząć odczyt?"],
      print: {
        worksheetTitle: "Mierzenie kąta",
        instructions: "Ustaw kątomierz na kącie ABC, zmierz kąt i wpisz jego miarę.",
        items: [
          { id: "setup-angle-measurement", skillIds: ["M5-4.3-measure-angles"], expression: "∠ABC", prompt: "Miara kąta: ______ °." },
        ],
      },
    },
    {
      suffix: "s3",
      kind: "discuss",
      title: "Kąt wklęsły — dwa przypadki",
      minutes: 6,
      headline: "Te same dane mogą utworzyć dwa różne kąty wklęsłe.",
      body: "Kąt ABC ma miarę 60°, a kąt DBC ma miarę 25°. Uczeń rozważa położenie ramienia BD po tej samej i po przeciwnej stronie ramienia BC, oblicza mniejszy kąt DBA, a następnie dopełnia go do 360°.",
      modelId: "geometry-lab",
      modelSeed: 430201,
      studentInstruction: "Rozwiąż oba przypadki. W każdym najpierw wpisz miarę mniejszego kąta DBA, a potem miarę kąta wklęsłego DBA.",
      teacherInstruction: "Nie podawaj działania. Dopilnuj, aby uczeń rozważył oba możliwe położenia ramienia BD i korzystał z pełnego kąta 360°.",
      discussionPrompts: ["Kiedy miary 60° i 25° odejmujemy, a kiedy dodajemy?", "Dlaczego kąt wklęsły obliczamy jako dopełnienie do 360°?"],
      print: {
        worksheetTitle: "Kąt wklęsły — dwa położenia ramienia",
        instructions: "Narysuj oba możliwe ustawienia ramienia BD i oblicz miarę kąta wklęsłego DBA.",
        items: [{ id: "reflex-angle-two-cases", skillIds: ["M5-4.3-measure-angles"], expression: "∠ABC = 60°, ∠DBC = 25°", prompt: "Przypadek I: mniejszy ∠DBA = ____°, wklęsły ∠DBA = ____°. Przypadek II: mniejszy ∠DBA = ____°, wklęsły ∠DBA = ____°." }],
      },
    },
    {
      suffix: "s4",
      kind: "practice",
      title: "Obrót wskazówki minutowej",
      minutes: 6,
      headline: "Połącz pełny obrót 360° z podziałem tarczy na 60 minut.",
      body: "Uczeń najpierw oblicza, o ile stopni obraca się wskazówka minutowa w ciągu jednej minuty. Następnie sam wyznacza obrót w ciągu kwadransa i pół godziny.",
      modelId: "geometry-lab",
      modelSeed: 430202,
      studentInstruction: "Uzupełnij kolejno trzy wyniki: obrót w ciągu jednej minuty, kwadransa oraz pół godziny. Zatwierdź jeden raz na końcu.",
      teacherInstruction: "Pozostaw uczniowi dzielenie 360° przez 60 i dalsze mnożenie. Rysunki zegarów pokazują drogę wskazówki, ale nie podają wyników.",
      print: {
        worksheetTitle: "Obrót wskazówki minutowej",
        instructions: "Oblicz miarę kąta, o jaki obraca się wskazówka minutowa.",
        items: [{ id: "minute-hand-turn", skillIds: ["M5-4.3-measure-angles"], expression: "Pełny obrót: 360°, tarcza: 60 minut", prompt: "1 minuta: ____°. Kwadrans: ____°. Pół godziny: ____°." }],
      },
    },
    {
      suffix: "s5",
  ...
  stages: [
    {
      ...
      title: "Kąty przyległe i wierzchołkowe",
      minutes: 5,
      headline: "Kąt α ma 50°. Oblicz miarę kąta naprzeciwko i kąta obok.",
      body: "Kąt naprzeciwko jest kątem wierzchołkowym i ma taką samą miarę. Kąt leżący obok jest przyległy do α, dlatego ich miary mają razem 180°.",
      modelId: "geometry-lab",
      modelSeed: 440101,
      studentInstruction: "Wpisz miarę kąta γ leżącego naprzeciwko α. Następnie wpisz miarę kąta β leżącego obok α. Zatwierdź jeden raz na końcu.",
      teacherInstruction: "Najpierw wskaż położenie kąta γ i β. Uczeń sam wpisuje obie miary.",
      discussionPrompts: ["Który kąt leży naprzeciwko α?", "Jak obliczyć kąt leżący obok α?"],
      print: {
        worksheetTitle: "Kąty przyległe i wierzchołkowe — pierwsze zadanie",
        instructions: "Kąt α ma 50°. Oblicz miarę kąta γ leżącego naprzeciwko oraz kąta β leżącego obok.",
        items: [
