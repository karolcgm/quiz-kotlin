...
export const m541ProsteRelacjeL1V1 = s4({
  ...
  stages: [
    ...
    },
    {
      ...
      minutes: 5,
      headline: "Wskaż proste i zastosuj ∥ lub ⟂",
      body: "Proste równoległe zapisujemy a ∥ b. Proste prostopadłe zapisujemy a ⟂ b i zaznaczamy kwadrat kąta prostego. Relacja nie zależy od ustawienia kartki.",
      modelId: "geometry-lab",
      modelSeed: 410101,
      studentInstruction: "Wybierz kolejno układ równoległy i prostopadły, a następnie obróć go do położenia ukośnego. Za każdym razem wskaż proste a i b oraz odczytaj symbol.",
      discussionPrompts: [
        "Co pozostaje niezmienne po obrocie całego układu?",
        "Jak wygląda symbol równoległości ∥?",
        "Dlaczego symbol prostopadłości ⟂ przypomina odwróconą literę T?",
      ],
      print: {
        worksheetTitle: "Proste równoległe i prostopadłe",
        instructions: "Każdą relację sprawdź w innym położeniu. Użyj małych liter a, b oraz symbolu ∥ albo ⟂.",
        items: [
    ...
    },
    {
      ...
      body: "Jedną krawędź ekierki przykładamy dokładnie do prostej a. Wzdłuż drugiej krawędzi prowadzimy prostą b. Na końcu zapisujemy a ⟂ b i zaznaczamy kąt prosty.",
      modelId: "geometry-lab",
      modelSeed: 411101,
      studentInstruction: "Obserwuj pokaz krok po kroku. Na tablecie wskaż poprawną kolejność; rysunek linijką i ekierką wykonuje się na papierze.",
      print: {
    ...
    },
    {
      ...
      minutes: 4,
      headline: "Przesuwamy ekierkę bez obracania",
      body: "Do prostej a przykładamy ekierkę i podpieramy ją linijką. Przesuwamy ekierkę wzdłuż linijki bez zmiany kierunku. Wzdłuż tej samej krawędzi rysujemy prostą b i zapisujemy a ∥ b.",
      modelId: "geometry-lab",
      modelSeed: 411201,
      studentInstruction: "Obserwuj ślad przesunięcia bez obrotu. Wskaż, co musi pozostać niezmienne, aby otrzymać prostą równoległą.",
      print: {
