  ...
  stages: [
    {
      ...
      minutes: 11,
      headline: "Zmierz trzy kąty za pomocą wirtualnego kątomierza.",
      body: "Wybieraj kolejne przykłady, za każdym razem samodzielnie ustaw kątomierz, odczytaj miarę kąta i wpisz ją w puste kratki.",
      modelId: "geometry-lab",
      modelSeed: 430101,
      studentInstruction: "Rozwiąż trzy przykłady. W każdym przesuń środek kątomierza na B, ustaw prostą krawędź na ramieniu BA, odczytaj miarę i wpisz ją za pomocą klawiatury liczbowej.",
      ...
      print: {
        ...
        instructions: "Ustaw kątomierz kolejno na trzech kątach ABC, zmierz każdy kąt i wpisz jego miarę.",
        items: [
  ...
  stages: [
    {
      ...
      body: "Najpierw porównaj dwie własności. Kąty wierzchołkowe leżą naprzeciwko i mają równe miary. Kąty przyległe mają wspólne ramię, a ich pozostałe ramiona tworzą prostą, dlatego suma ich miar wynosi 180°. Potem samodzielnie oblicz dwa brakujące kąty.",
      modelId: "geometry-lab",
      modelSeed: 440101,
