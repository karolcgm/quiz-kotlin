  ...
  stages: [
    ...
    },
    {
      ...
      print: {
        ...
        items: [
          { id: "figure-angle-abc", expression: "∠ABC", prompt: "Kąt ABC jest ____________________." },
          { id: "figure-angle-bcd", expression: "∠BCD", prompt: "Kąt BCD jest ____________________." },
          { id: "figure-angle-bad", expression: "∠BAD", prompt: "Kąt BAD jest ____________________." },
        ],
      },
    },
    {
