...
export const m5DiagStacjeStartoweV1: LessonPackage = {
  ...
  stages: [
    createLessonStage({ id: "m5-diag-s1", kind: "warmup", title: "Start", studentInstruction: "Spójrz na ekran nauczyciela i wybierz strefę startową.", teacherInstruction: "Uruchom misję i wybierz jedną z trzech stref; nie rozwiązuj jeszcze stacji.", estimatedMinutes: 5, live: { enabled: true, kind: "presentation", minutes: 4 }, board: { layout: "model", headline: "Startujemy bez ocen", modelId: "live-launch-pad", modelSeed: 1 } }),
