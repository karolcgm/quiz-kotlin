...
export const m5DiagStacjeStartoweV1: LessonPackage = {
  ...
  stages: [
    createLessonStage({ id: "m5-diag-s1", kind: "warmup", title: "Start", studentInstruction: "Spójrz na tablicę i wybierz sposób działania.", teacherInstruction: "Wprowadź bez oceny, uruchamiając pierwszą stację widgetu.", estimatedMinutes: 5, live: { enabled: true, kind: "presentation", minutes: 3 }, board: { layout: "model", headline: "Startujemy bez ocen", modelId: "diagnostic-stations", modelSeed: 1 } }),
    createLessonStage({ id: "m5-diag-s2", kind: "explore", title: "Stacje", studentInstruction: "Wybierz stację na tablecie lub pracuj z tablicą.", teacherInstruction: "Prowadź maksymalnie cztery krótkie stacje. Na tabletach uczniowie wybierają pierwszy znak działania — bez wpisywania.", estimatedMinutes: 12, live: { enabled: true, kind: "exercise", minutes: 7 }, board: { layout: "model", headline: "Stacje startowe", modelId: "diagnostic-stations", modelSeed: 1 }, student: { activityMode: "practice", instruction: "Dotknij znaku, od którego zaczniesz działanie. Odpowiedź zapisze się po wysłaniu.", modelId: "diagnostic-stations", modelSeed: 1 } }, [{ id: "m5-diag-order-01", generatorId: "order-director-v1", seed: 1042, difficulty: "core" }]),
    createLessonStage({ id: "m5-diag-s3", kind: "practice", title: "Ćwiczenia z podręcznika", studentInstruction: "Wykonuj wskazane przez nauczyciela ćwiczenia.", teacherInstruction: "Tu przejmujesz pełną kontrolę: podręcznik, zeszyt ćwiczeń, własne pytania.", estimatedMinutes: 20, live: { enabled: true, kind: "exercise", minutes: 7 }, board: { layout: "model", headline: "Ćwiczenia z podręcznika", modelId: "exercise-board", modelSeed: 1 } }),
    createLessonStage({ id: "m5-diag-s4", kind: "discuss", title: "Mapa klasy", studentInstruction: "Pokaż gestem, do czego warto wrócić.", teacherInstruction: "Zaznacz na widgetcie pola, do których klasa ma wrócić, i wybierz pierwszy temat działu 1.", estimatedMinutes: 8, live: { enabled: true, kind: "quick-check", minutes: 3 }, board: { layout: "model", headline: "Co przypominamy przed działem 1?", modelId: "exercise-board", modelSeed: 2 } }),
  ],
};
