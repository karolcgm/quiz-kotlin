...
export const m617RozwinieciaDziesietneV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    ...
    { suffix: "decimal-long-division", kind: "practice", title: "Dzielenie oraz rodzaj rozwinięcia", minutes: 26, headline: "Rozwinięcie przez dzielenie pisemne", body: "Wykonaj dzielenie, nazwij otrzymane rozwinięcie i — jeśli jest okresowe — wpisz jego najkrótszy okres.", modelId: "decimal-notation-l1", modelSeed: 617300, questions: questions("division", 6, "M6-1.7-division", 617300), preserveTaskTitle: true, studentInstruction: "Wykonaj dzielenie, wybierz nazwę rozwinięcia i wpisz okres albo zaznacz jego brak.", teacherInstruction: "Zwróć uwagę na dopisywanie zer, resztę równą zero oraz powtarzającą się resztę." },
  ], status: "published",
});
