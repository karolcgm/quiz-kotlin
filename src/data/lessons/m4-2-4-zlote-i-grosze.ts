...
export const m424ZloteIGroszeV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    {
      suffix: "information", kind: "explore", title: "Złote i grosze", minutes: 6,
    ...
    {
      suffix: "example", kind: "worked-example", title: "Przykład zakupów", minutes: 7,
    ...
    {
      suffix: "zl-to-gr", kind: "practice", title: "Złote na grosze", minutes: 8,
    ...
    {
      suffix: "gr-to-zl-gr", kind: "practice", title: "Grosze na złote i grosze", minutes: 9,
    ...
    {
      suffix: "story", kind: "challenge", title: "Zadania z treścią", minutes: 15,
