...
export const m642PredkoscV1 = buildLessonPackage({
  ...
  overview: "Lekcja ponownie wykorzystuje słowny trójkąt drogi, prędkości i czasu. Seria pięciu zadań obejmuje prędkości w kilometrach na godzinę, metrach na minutę i metrach na sekundę.",
  ...
  stageBlueprints: [
    ...
    },
    {
      ...
      kind: "worked-example",
      title: "Prędkość samolotu — przykład",
      minutes: 8,
      headline: "Samolot przeleciał 2400 km w ciągu 4 godzin",
    ...
    },
    {
      ...
      minutes: 22,
      headline: "Oblicz prędkość",
      body: "Odczytaj dane z opowieści, samodzielnie wybierz działanie i wpisz wynik w jednostce wskazanej w zadaniu.",
      modelId: "distance-motion-lab",
      preserveTaskTitle: true,
      questions: seriesQuestion,
      studentInstruction: "W pierwszym zadaniu zobaczysz zapis działania. W kolejnych samodzielnie zdecyduj, jak wykorzystać drogę i czas.",
