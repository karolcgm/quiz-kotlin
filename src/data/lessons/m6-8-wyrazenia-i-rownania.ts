...
export const m682WartoscWyrazenV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    ...
    { suffix: "evaluate-exit", kind: "exit-ticket", title: "Samodzielne podstawienie", minutes: 8, headline: "Pokaż cały tok obliczenia", body: "Ostatnia seria sprawdza samodzielny wybór miejsca x, podstawienie liczb ujemnych i ułamków oraz kolejność działań.", modelId, preserveTaskTitle: true, questions: questions("2-exit", 4, 682300, ["M6-8.2-substitute", "M6-8.2-multiplication", "M6-8.2-order", "M6-8.2-evaluate"]), studentInstruction: "W każdym zadaniu najpierw wskaż x i wybierz właściwą liczbę, a następnie samodzielnie oblicz wynik.", teacherInstruction: "Ostatnia seria jest dowodem do kryteriów na slajdzie końcowym." },
  ], status: "published",
});
