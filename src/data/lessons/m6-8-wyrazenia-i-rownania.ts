...
export const m682WartoscWyrazenV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    ...
    { suffix: "evaluate", kind: "practice", title: "Uruchom maszynę", minutes: 25, headline: "Oblicz wartość wyrażenia", body: "Przesuń suwak z x na podaną liczbę, odczytaj wyrażenie po podstawieniu i samodzielnie wpisz wynik klawiaturą lekcyjną. Seria obejmuje liczby dodatnie, ujemne i ułamki.", modelId, preserveTaskTitle: true, questions: questions("2-evaluate", 8, 682100, ["M6-8.2-substitute", "M6-8.2-multiplication", "M6-8.2-order", "M6-8.2-evaluate"]), studentInstruction: "Najpierw zamień x na liczbę suwakiem. Potem wykonaj działania i wpisz ostateczny wynik.", teacherInstruction: "Przy odpowiedzi poproś o odczytanie zapisu po podstawieniu, nie tylko o wynik." },
    { suffix: "evaluate-exit", kind: "exit-ticket", title: "Samodzielne podstawienie", minutes: 8, headline: "Pokaż cały tok obliczenia", body: "Ostatnia seria sprawdza samodzielne podstawienie liczb ujemnych i ułamków oraz kolejność działań.", modelId, preserveTaskTitle: true, questions: questions("2-exit", 4, 682300, ["M6-8.2-substitute", "M6-8.2-multiplication", "M6-8.2-order", "M6-8.2-evaluate"]), studentInstruction: "W każdym zadaniu najpierw zamień x na liczbę, a następnie samodzielnie oblicz wynik.", teacherInstruction: "Ostatnia seria jest dowodem do kryteriów na slajdzie końcowym." },
  ], status: "published",
});
