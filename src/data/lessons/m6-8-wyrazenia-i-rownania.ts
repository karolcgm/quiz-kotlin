...
export const m683UpraszczanieWyrazenV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    ...
    { suffix: "simplify-multiply-divide", kind: "practice", title: "Mnożenie i dzielenie", minutes: 12, headline: "Oblicz współczynnik", body: "Wykonaj mnożenie albo dzielenie liczb stojących przy x. Litera pozostaje w wyniku.", modelId, preserveTaskTitle: true, questions: questions("3-multiply-divide", 6, 683400, ["M6-8.3-coefficient", "M6-8.3-simplify"]), studentInstruction: "Oblicz działanie na liczbach i wpisz całe uproszczone wyrażenie.", teacherInstruction: "Proś o głośne wskazanie działania na współczynnikach przed wpisaniem wyniku." },
    { suffix: "simplify-mixed", kind: "exit-ticket", title: "Działania mieszane", minutes: 14, headline: "Zachowaj kolejność działań", body: "Najpierw wykonaj mnożenie i dzielenie, potem połącz wyrazy podobne przez dodawanie lub odejmowanie.", modelId, preserveTaskTitle: true, questions: questions("3-mixed", 6, 683604, ["M6-8.3-like-terms", "M6-8.3-coefficient", "M6-8.3-simplify", "M6-8.3-explain"]), studentInstruction: "Upraszczaj etapami i wpisz całe wyrażenie końcowe.", teacherInstruction: "Ostatnia seria sprawdza wszystkie kryteria tematu i zasila profil umiejętności." },
  ], status: "published",
});
