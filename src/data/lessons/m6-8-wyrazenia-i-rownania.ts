...
export const m683UpraszczanieWyrazenV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    ...
    { suffix: "simplify", kind: "practice", title: "Dodawanie i odejmowanie", minutes: 15, headline: "Połącz wyrazy podobne", body: "Dodaj lub odejmij liczby stojące przy x. Wpisz całe uproszczone wyrażenie.", modelId, preserveTaskTitle: true, questions: questions("3-simplify", 6, 683202, ["M6-8.3-coefficient", "M6-8.3-simplify"]), studentInstruction: "Połącz tylko wyrazy podobne i wpisz cały wynik, na przykład 5x albo 2x + 3.", teacherInstruction: "Zwróć uwagę, czy uczeń zachowuje literę x i nie łączy z nią liczby bez x." },
