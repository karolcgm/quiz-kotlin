...
export const m681ZapisywanieWyrazenV1 = buildLessonPackage({
  ...
  studentGoal: "Zrozumiem, czym jest litera x, i zapiszę wyrażenie opisujące sytuację.",
  successCriteria: [
  ...
  estimatedMinutes: 45,
  coreLesson: "Litera jako liczba, znaczenie współczynnika i zapis sytuacji za pomocą wyrażenia algebraicznego.",
  paperEvidence: "Zeszyt ucznia: trzy własne sytuacje z wyjaśnieniem znaczenia x i odpowiadającymi im wyrażeniami.",
  overview: "Pierwsze spotkanie ucznia z algebrą. Lekcja prowadzi od tajemniczego pudełka z liczbą przez jednakowe grupy do zapisu symbolicznego.",
  ...
  stageBlueprints: [
    ...
    { suffix: "translate", kind: "practice", title: "Od słów do wyrażenia", minutes: 15, headline: "Przetłumacz sytuację na język algebry", body: "Rozpoznaj liczbę x, operację i kolejność elementów.", modelId, preserveTaskTitle: true, questions: questions("1-translate", 8, 681100, ["M6-8.1-x-meaning", "M6-8.1-translate"]), teacherInstruction: "Po każdym wyborze poproś o wskazanie słowa, które zdecydowało o działaniu.", studentInstruction: "Wybierz wyrażenie, które dokładnie opisuje podaną sytuację." },
    { suffix: "build-expression", kind: "exit-ticket", title: "Zbuduj i odczytaj wyrażenie", minutes: 10, headline: "Połącz model z zapisem", body: "Odczytaj grupy x i zapisz je krócej za pomocą współczynnika.", modelId, preserveTaskTitle: true, questions: questions("1-exit", 4, 681300, ["M6-8.1-same-variable", "M6-8.1-coefficient", "M6-8.1-translate", "M6-8.1-x-meaning"]), teacherInstruction: "Wymagaj odczytania 4x jako czterech grup po x, a nie jako pojedynczego słowa.", studentInstruction: "Wybierz zapis odpowiadający modelowi i wyjaśnij znaczenie współczynnika." },
  ],
  status: "published",
});
