...
export const m531UlamkiMieszaneL2V1 = s3({
  ...
  paperEvidence: "Karta L2: klasyfikacja ułamków, odczyt pokolorowanych kół, ułamki jednostek oraz zamiana ułamka niewłaściwego na liczbę mieszaną.",
  studentGoal: "Uczeń rozpoznaje ułamki właściwe i niewłaściwe, odczytuje model większy od całości, zapisuje część jednostki i zamienia ułamek niewłaściwy na liczbę mieszaną.",
  successCriteria: [
  ...
  stages: [
    ...
    },
    {
      ...
      minutes: 8,
      headline: "Zgrupuj pełne całości i odczytaj resztę",
      body: "Cztery zadania mają małe modele pełnych grup i reszty. Uczeń grupuje pełne całości, a następnie zapisuje pozostałe części jako ułamek.",
      modelId: "fraction-lesson",
      modelSeed: 31204,
      studentInstruction: "Rozwiąż cztery zamiany ułamka niewłaściwego na liczbę mieszaną. Grupuj pełne całości na modelu i zapisz resztę.",
      print: {
        worksheetTitle: "Z ułamka niewłaściwego do liczby mieszanej",
        instructions: "Zgrupuj pełne całości, a pozostałe części zapisz jako ułamek.",
        items: [
          { id: "m531-l2-mixed", skillIds: [m531L2SkillIds[1]!], expression: "7/4", prompt: "Zamień na liczbę mieszaną.", answerLayout: "fraction-stack" },
          { id: "m531-l2-mixed-quarters", skillIds: [m531L2SkillIds[1]!], expression: "8/3", prompt: "Zamień na liczbę mieszaną.", answerLayout: "fraction-stack" },
          { id: "m531-l2-mixed-thirds", skillIds: [m531L2SkillIds[1]!], expression: "11/5", prompt: "Zamień na liczbę mieszaną.", answerLayout: "fraction-stack" },
          { id: "m531-l2-mixed-halves", skillIds: [m531L2SkillIds[1]!], expression: "9/2", prompt: "Zamień na liczbę mieszaną.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
      ...
      modelId: "fraction-lesson",
      modelSeed: 31200,
      studentInstruction: "Rozwiąż pięć kolejnych zadań na jednej osi liczbowej od 0 do 6. Zaznaczaj ułamki właściwe i niewłaściwe po zatwierdzeniu poprzedniego.",
      ...
      print: {
        ...
        instructions: "Zaznacz na osi od 0 do 6 podane ułamki. W serii są ułamki właściwe i niewłaściwe.",
        items: [
  ...
  stages: [
    {
      ...
      minutes: 5,
      headline: "3/7 pozostaje tą samą częścią po podziale każdego segmentu na 2, 3 albo 4 części",
      ...
      print: {
        ...
        instructions: "Podziel każdą siódmą część paska na mniejsze równe części. Zachowaj ten sam zakres zaznaczenia i zapisz pionowe ułamki.",
        items: [
          { id: "m533-denser-two", skillIds: ["M5-3.3-equivalent-fractions", "M5-3.3-same-factor"], expression: "3/7 = 6/14", prompt: "Narysuj oba paski i zaznacz tę samą część. Podpisz mnożnik licznika i mianownika.", answerLayout: "fraction-stack" },
          { id: "m533-denser-four", skillIds: ["M5-3.3-equivalent-fractions", "M5-3.3-same-factor"], expression: "3/7 = 12/28", prompt: "Zagęść podział czterokrotnie i pokaż, że położenie na osi jest niezmienne.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
      ...
      minutes: 5,
      headline: "5/8 · 3/3 = 15/24 — identyczny symbol łączy parę mnożników",
      ...
      print: {
        ...
        items: [
          { id: "m533-expand-three", skillIds: ["M5-3.3-simplify-expand", "M5-3.3-same-factor"], expression: "5/8 = 15/24", prompt: "Uzupełnij dwa mnożniki i podpisz, dlaczego wartość się nie zmieniła.", answerLayout: "fraction-stack" },
          { id: "m533-expand-twenty", skillIds: ["M5-3.3-simplify-expand"], expression: "7/11 = ?/44", prompt: "Znajdź wspólny mnożnik i brakujący licznik.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
      ...
      title: "Zwiń podział",
      minutes: 5,
      headline: "16/28 zwija się do 4/7 przez grupowanie po 4 sąsiednie części",
      ...
      discussionPrompts: ["Co opisuje jedna nowa grupa?", "Dlaczego 16 : 4 i 28 : 2 zmieniają wartość?"],
      print: {
        ...
        items: [
          { id: "m533-collapse-eight", skillIds: ["M5-3.3-simplify-expand", "M5-3.3-equivalent-fractions"], expression: "16/28 = 4/7", prompt: "Pokaż grupy po 4 i pionowy zapis skracania.", answerLayout: "fraction-stack" },
          { id: "m533-collapse-eighteen", skillIds: ["M5-3.3-simplify-expand"], expression: "35/49", prompt: "Zgrupuj części wspólnym dzielnikiem i skróć.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
      ...
      minutes: 5,
      headline: "54/72 : 18/18 = 3/4 — stare liczby zostają jako czytelny ślad",
      ...
      discussionPrompts: ["Po co zachowujemy przekreślony ślad?", "Jak model lub oś sprawdzają wynik 3/4?"],
      print: {
        ...
        items: [
          { id: "m533-cross-twenty-four", skillIds: ["M5-3.3-simplify-expand", "M5-3.3-irreducible-form"], expression: "54/72", prompt: "Skróć przez 18 i pozostaw pełny ślad operacji.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
      ...
      discussionPrompts: ["Czy istnieje tylko jeden ułamek równoważny 4/9?", "Jak bez modelu sprawdzisz dwa ułamki?"],
      print: {
        ...
        items: [
          { id: "m533-chain", skillIds: ["M5-3.3-equivalent-fractions", "M5-3.3-same-factor"], expression: "4/9 = 8/18 = ?/? = 16/36", prompt: "Uzupełnij 12/27 i uzasadnij jeden krok.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
      ...
      kind: "challenge",
      title: "Laboratorium mozaiki",
      minutes: 5,
      headline: "4/7, 8/14 i 12/21 opisują tę samą kolorową część mozaiki",
      body: "Ta sama mozaika jest dzielona na 7, 14 i 21 równych pól. Zsynchronizowane modele oraz punkty osi pokazują, że zmienia się opis podziału, nie kolorowa powierzchnia.",
      modelId: "fraction-lesson",
      modelSeed: 33036,
      studentInstruction: "Porównaj trzy podziały mozaiki. Użyj modelu, pionowego zapisu i osi, aby dowieść, że kolorowa część ma tę samą wartość.",
      discussionPrompts: ["Który zapis najlepiej pasuje do podziału na 21 pól?", "Jak z 4/7 otrzymać oba pozostałe zapisy?"],
      print: {
        worksheetTitle: "Laboratorium mozaiki",
        instructions: "Pokoloruj tę samą część trzech jednakowych figur podzielonych na 7, 14 i 21 pól.",
        items: [
          { id: "m533-paint", skillIds: ["M5-3.3-equivalent-fractions", "M5-3.3-same-factor"], expression: "4/7 = 8/14 = 12/21", prompt: "Zamaluj pola, połącz równe punkty osi i podpisz mnożniki.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
      ...
      print: {
        ...
        items: [
          { id: "m533-print-support", questionId: "m533-support", skillIds: [...m533L1SkillIds], maxScore: 3, expression: "2/7 → 4/14 → 2/7", prompt: "Wpisz parę mnożników, parę dzielników i wyjaśnij niezmienną wartość.", answerLayout: "fraction-stack" },
          { id: "m533-print-core", questionId: "m533-core", skillIds: [...m533L1SkillIds], maxScore: 3, expression: "4/9 → 16/36 → 4/9", prompt: "Pokaż rozszerzenie i dowolną poprawną ścieżkę do postaci nieskracalnej.", answerLayout: "fraction-stack" },
          { id: "m533-print-challenge", questionId: "m533-challenge", skillIds: [...m533L1SkillIds], maxScore: 3, expression: "7/12 → 42/72 → 7/12", prompt: "Zostaw ślad wszystkich operacji i sprawdź wartość na szkicu osi.", answerLayout: "fraction-stack" },
          { id: "m533-print-core-chain", questionId: "m533-core-chain", skillIds: [...m533L1SkillIds], maxScore: 3, expression: "5/11 → 20/44 → 5/11", prompt: "Uzupełnij ten sam mnożnik i dzielnik nad oraz pod kreską.", answerLayout: "fraction-stack" },
          { id: "m533-print-challenge-irreducible", questionId: "m533-challenge-irreducible", skillIds: [...m533L1SkillIds], maxScore: 3, expression: "44/66 → ?/?", prompt: "Wybierz poprawną ścieżkę i zakończ w postaci nieskracalnej.", answerLayout: "fraction-stack" },
        ],
      },
    },
  ],
