...
export const m531JednaCaloscV1 = s3({
  ...
  paperEvidence: "Karta L1: zaznaczanie części całości, odczytywanie udziału kolorów i podpisywanie punktów na osi pionowym zapisem ułamka.",
  ...
  stages: [
    {
      ...
      minutes: 14,
      headline: "Zaznacz cztery z siedmiu części i odczytaj kolorowy zbiór",
      body: "Pierwsze zadanie pozwala naciskać siedem równych pól. Drugie pokazuje dwanaście kółek w czterech kolorach i osobne miejsce na pionowy ułamek dla każdego koloru.",
      modelId: "fraction-lesson",
      modelSeed: 31011,
      studentInstruction: "Najpierw zaznacz dokładnie cztery części. Potem policz wszystkie kółka i zapisz, jaką ich część stanowi każdy kolor.",
  ...
  stages: [
    {
      ...
      modelId: "fraction-lesson",
      modelSeed: 31201,
      studentInstruction: "Dla każdego pionowego ułamka wybierz właściwy rodzaj. Klasyfikuj także przykład równy jednej całości.",
      print: {
    ...
    },
    {
      ...
      body: "Dwa podzielone koła pokazują siedem pokolorowanych ćwiartek. Uczeń wpisuje osobno ułamek niewłaściwy i liczbę mieszaną.",
      modelId: "fraction-lesson",
      modelSeed: 31202,
      studentInstruction: "Policz wszystkie pokolorowane części, a potem oddziel pełne koło od pozostałej części. Uzupełnij oba pionowe zapisy.",
      print: {
    ...
    },
    {
      ...
      body: "Dwa niezależne zadania dotyczą odległości i masy. Uczeń najpierw ustala liczbę mniejszych jednostek w jednej większej.",
      modelId: "fraction-lesson",
      modelSeed: 31203,
      studentInstruction: "Rozwiąż oba zadania: 7 mm jako część 1 cm oraz 300 g jako część 1 kg. Wpisuj ułamki pionowo.",
      print: {
    ...
    },
    {
      ...
      body: "Graficzna podpowiedź podświetla kolejno część całkowitą, mianownik i licznik. Zamiana odbywa się tylko w stronę ułamka niewłaściwego.",
      modelId: "fraction-lesson",
      modelSeed: 31204,
      studentInstruction: "Zamień dwie i trzy piąte na ułamek niewłaściwy. Użyj podpowiedzi: mnożenie, dodawanie, niezmienny mianownik.",
      print: {
