...
export const m531UlamkiMieszaneL2V1 = s3({
  ...
  stages: [
    ...
    {
      suffix: "topic1-mixed-to-improper-example",
      kind: "worked-example",
      title: "Jak zamienić liczbę mieszaną?",
      minutes: 4,
      headline: "Pomnóż całości przez mianownik i dodaj licznik",
      body: "Osobny slajd pokazuje jeden czytelny przykład zamiany. Mianownik pozostaje bez zmiany.",
      modelId: "fraction-lesson",
      modelSeed: 31204,
      studentInstruction: "Prześledź trzy kroki zamiany liczby mieszanej na ułamek niewłaściwy.",
      print: {
        worksheetTitle: "Jak zamienić liczbę mieszaną?",
        instructions: "Prześledź przykład i zapisz trzy kroki zamiany.",
        items: [
          { id: "m531-l2-mixed-example", skillIds: [m531L2SkillIds[1]!], expression: "2 i trzy piąte", prompt: "Pomnóż całości przez mianownik, dodaj licznik i pozostaw mianownik.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
      ...
      minutes: 7,
      headline: "Zamiana liczb mieszanych",
      body: "Cztery przykłady pojawiają się kolejno w jednym slajdzie. Po przesłaniu poprawnego wyniku automatycznie otwiera się następne zadanie.",
      modelId: "fraction-lesson",
      modelSeed: 31204,
      studentInstruction: "Wpisz ułamek niewłaściwy i użyj jednego przycisku „Prześlij zadanie”.",
      print: {
        ...
        items: [
          { id: "m531-l2-mixed", skillIds: [m531L2SkillIds[1]!], expression: "2 i trzy piąte", prompt: "Zamień na ułamek niewłaściwy.", answerLayout: "fraction-stack" },
          { id: "m531-l2-mixed-quarters", skillIds: [m531L2SkillIds[1]!], expression: "1 i trzy czwarte", prompt: "Zamień na ułamek niewłaściwy.", answerLayout: "fraction-stack" },
          { id: "m531-l2-mixed-thirds", skillIds: [m531L2SkillIds[1]!], expression: "3 i dwie trzecie", prompt: "Zamień na ułamek niewłaściwy.", answerLayout: "fraction-stack" },
          { id: "m531-l2-mixed-halves", skillIds: [m531L2SkillIds[1]!], expression: "4 i jedna druga", prompt: "Zamień na ułamek niewłaściwy.", answerLayout: "fraction-stack" },
        ],
      },
    },
    {
...
export const m536RozneMianownikiL2V1 = s3({
  ...
  stages: [
    ...
    },
    {
      ...
      body: "Seria zawiera dodawanie i odejmowanie ułamków oraz liczb mieszanych. Uczeń sam zapisuje oba ułamki ze wspólnym mianownikiem, wynik działania, a gdy to potrzebne także postać skróconą lub liczbę mieszaną. Każdy etap ma tyle kratek, ile cyfr wymaga zapis.",
      modelId: "fraction-lesson",
      modelSeed: 360625,
      ...
      live: { enabled: true, kind: "exercise", minutes: 20 },
      questions: [
        ...
        { id: "m536l2-11", generatorId: "fraction-lesson-l1-v1", seed: 536211, difficulty: "challenge", skillIds: [...m536L2SkillIds], feedbackPolicy: { mode: "assessment", allowsPartialCredit: true, manualReview: "possible", feedbackKeys: [...FRACTION_DIFFERENT_DENOMINATOR_ADVANCED_FEEDBACK_KEYS] } },
        { id: "m536l2-12", generatorId: "fraction-lesson-l1-v1", seed: 536212, difficulty: "challenge", skillIds: [...m536L2SkillIds], feedbackPolicy: { mode: "assessment", allowsPartialCredit: true, manualReview: "possible", feedbackKeys: [...FRACTION_DIFFERENT_DENOMINATOR_ADVANCED_FEEDBACK_KEYS] } },
        { id: "m536l2-13", generatorId: "fraction-lesson-l1-v1", seed: 536213, difficulty: "challenge", skillIds: [...m536L2SkillIds], feedbackPolicy: { mode: "assessment", allowsPartialCredit: true, manualReview: "possible", feedbackKeys: [...FRACTION_DIFFERENT_DENOMINATOR_ADVANCED_FEEDBACK_KEYS] } },
        { id: "m536l2-14", generatorId: "fraction-lesson-l1-v1", seed: 536214, difficulty: "challenge", skillIds: [...m536L2SkillIds], feedbackPolicy: { mode: "assessment", allowsPartialCredit: true, manualReview: "possible", feedbackKeys: [...FRACTION_DIFFERENT_DENOMINATOR_ADVANCED_FEEDBACK_KEYS] } },
...
const fractionDivisionStages = (input: {
  ...
  const examples = level === "l3" ? [
    ...
    { expression: "1 5/6 : 11/12", prompt: "Wykonaj zamianę, mnożenie przez odwrotność i kontrolę." },
    ...
    { expression: "4/5 : 2/3", prompt: "Zapisz mnożenie przez odwrotność i skróć wynik." },
  ...
  return operationStages({
    ...
    level: input.level,
    skillIds: input.skillIds,
    visualTitle: level === "l3" ? "Liczba mieszana : ułamek" : level === "l2" ? "Skracanie przed mnożeniem" : "Ile razy mieści się miara?",
    ...
    reasoningHeadline: level === "l3" ? "Najpierw zamień obie liczby mieszane" : level === "l2" ? "Zapisz ułamek niewłaściwy jako liczbę mieszaną" : "Mnożenie przez odwrotność",
    ...
    if (index === 0) return {
      ...stage,
      title: level === "l3" ? "Liczba mieszana : ułamek" : level === "l2" ? "Skracanie przed mnożeniem" : "Ile razy mieści się miara?",
      ...
      body: level === "l1"
        ...
        : level === "l2"
          ? "Po zapisaniu mnożenia przez odwrotność uczeń przekreśla obie pary po skosie i wpisuje ich nowe wartości w małych aktywnych kratkach."
          : "Uczeń zamienia liczbę mieszaną na ułamek niewłaściwy, zapisuje mnożenie przez odwrotność i zachowuje wszystkie etapy obliczeń.",
    };
    if (index === 1) return {
      ...stage,
      title: level === "l3" ? "Dwie liczby mieszane" : level === "l2" ? "Wynik większy od jedności" : "Mnożenie przez odwrotność",
      headline: level === "l3" ? "Dwie zamiany przed dzieleniem — 3 działania" : level === "l2" ? "Ułamek niewłaściwy i liczba mieszana" : "Dzielenie zastępujemy mnożeniem przez odwrotność",
      body: level === "l3"
        ? "Uczeń sam wpisuje obie liczby mieszane, dwa ułamki niewłaściwe, mnożenie przez odwrotność, skracanie i wynik."
        : "Uczeń wpisuje dzielną i dzielnik, zapisuje mnożenie przez odwrotność, wykonuje skracanie oraz zapisuje wynik w wymaganej postaci.",
    };
    if (index === 2) return {
      ...stage,
...
export const m537PowtorzPorcjeV1 = s3({
  ...
  studentGoal: "Uczeń mnoży ułamek przez liczbę naturalną oraz ułamek przez ułamek, skracając przed mnożeniem.",
  successCriteria: ["Potrafię mnożyć ułamek przez liczbę naturalną.", "Potrafię mnożyć ułamek przez ułamek i skracać przed mnożeniem."],
...
export const m538PodzielPotemWybierzV1 = s3({
  ...
  studentGoal: "Uczeń oblicza ułamek liczby naturalnej i wykorzystuje tę umiejętność w zadaniach tekstowych.",
  successCriteria: ["Potrafię obliczyć ułamek liczby naturalnej.", "Potrafię zapisać i wykonać potrzebne mnożenie.", "Potrafię rozwiązać zadanie tekstowe wymagające obliczenia ułamka liczby."],
...
export const m539CzescCzesciV1 = s3({
  ...
  studentGoal: "Uczeń mnoży ułamek przez ułamek, skraca przed mnożeniem oraz rozpoznaje i zapisuje liczby odwrotne.",
  successCriteria: ["Potrafię pomnożyć ułamek przez ułamek i skrócić przed mnożeniem.", "Potrafię wskazać i zapisać liczbę odwrotną do podanej liczby."],
...
export const m5311IleRazyMiaraV1 = s3({
  ...
  studentGoal: "Uczeń dzieli ułamek przez ułamek, stosując mnożenie przez odwrotność, oraz sprawdza wynik mnożeniem.",
  successCriteria: ["Potrafię wyjaśnić, ile razy dzielnik mieści się w dzielnej.", "Potrafię zamienić dzielenie ułamków na mnożenie przez odwrotność.", "Potrafię sprawdzić wynik mnożeniem."],
  prerequisiteSkillIds: ["M5-3.10-divide-by-natural"],
  skillIds: ["M5-3.11-divide-fractions"],
  estimatedMinutes: 45,
  overview: "Od modelu pomiarowego do pełnego dzielenia ułamków przez mnożenie przez odwrotność.",
  ...
  commonMisconceptions: ["Mylenie ułamka odwrotnego z dzielną.", "Mylenie dzielenia z odejmowaniem."],
...
export const m538ZastosowaniaUlamkaLiczbyL2V1 = s3({
  ...
  studentGoal: "Uczeń sprawnie oblicza ułamek liczby naturalnej i wykorzystuje tę umiejętność w trudniejszych zadaniach tekstowych.",
  successCriteria: ["Potrafię obliczyć ułamek większej liczby naturalnej.", "Potrafię skrócić liczby przed mnożeniem.", "Potrafię ocenić, czy otrzymany wynik ma sens."],
  prerequisiteSkillIds: ["M5-3.8-fraction-of-number"],
...
export const m5311OdwrotnoscL2V1 = s3({
  ...
  topicId: "M5-3.11",
  title: "Dzielenie ułamków",
  coreLesson: "Skracanie przed mnożeniem przez odwrotność — poziom 2",
  paperEvidence: "Dwie pary skracania, ułamki niewłaściwe i kontrola wyniku.",
  studentGoal: "Uczeń sprawnie dzieli ułamki, stosuje mnożenie przez odwrotność, skraca obie pary i zapisuje wynik jako liczbę mieszaną, gdy jest to potrzebne.",
  successCriteria: ["Potrafię zapisać mnożenie przez odwrotność.", "Potrafię skrócić obie pary przed mnożeniem.", "Potrafię zapisać ułamek niewłaściwy jako liczbę mieszaną i sprawdzić wynik."],
...
export const m5311LiczbyMieszaneL3V1 = s3({
  ...
  successCriteria: ["Potrafię zamienić każdą liczbę mieszaną przed działaniem.", "Potrafię zapisać mnożenie przez odwrotność i wykonać skracanie.", "Potrafię zapisać wynik w odpowiedniej postaci i sformułować odpowiedź."],
