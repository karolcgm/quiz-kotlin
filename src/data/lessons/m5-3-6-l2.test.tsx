...
describe("WP-S3-06B — M5-3.6 L2", () => {
  it("jest osobnym L2 z oficjalną nazwą, podstawą IV.4 i V.1 oraz czasem 45 minut", () => {
  ...
  it("ma pięć etapów L2 z planu i końcową Ocenę umiejętności", () => {
    expect(m536RozneMianownikiL2V1.stages.map((stage) => stage.title)).toEqual([
      "Cele lekcji (slajd 0)",
      "Odejmowanie na paskach",
