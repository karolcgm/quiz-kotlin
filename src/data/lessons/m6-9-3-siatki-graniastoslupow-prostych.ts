...
export const m693SiatkiGraniastoslupowProstychV1 = buildLessonPackage({
  ...
  studentGoal: "Rozpoznam, sprawdzę i narysuję siatkę graniastosłupa prostego.",
  successCriteria: [
    ...
    "Rysuję siatkę wskazanego graniastosłupa prostego.",
  ],
  learningGoals: [
    {
    ...
    {
      id: "m6-9-3-goal-draw",
      studentGoal: "Nauczę się rysować siatkę graniastosłupa prostego.",
      successCriteria: ["Rysuję dwie jednakowe podstawy oraz właściwą liczbę ścian bocznych."],
      curriculumReferences: [],
    },
  ],
  ...
  estimatedMinutes: 50,
  coreLesson: "Rozkładanie graniastosłupów prostych, rozpoznawanie poprawnych i niepoprawnych siatek oraz samodzielne rysowanie siatek.",
  ...
  overview: "Lekcja łączy animowane rozkładanie brył, serię zadań rozpoznawania oraz planszę do samodzielnego rysowania siatki.",
  ...
  stageBlueprints: [
    ...
    {
      suffix: "draw-s3", kind: "practice", title: "Narysuj siatkę", minutes: 15,
      headline: "Zbuduj własny rysunek siatki", body: "Rysuj palcem lub myszą na kratkowanej planszy. W razie potrzeby porównaj swoją pracę z wzorem.",
      modelId: netsModel, modelSeed: 69303, preserveTaskTitle: true,
      studentInstruction: "Narysuj siatkę wskazanego graniastosłupa. Sprawdź liczbę podstaw i ścian bocznych.",
    },
  ],
  status: "published",
});
