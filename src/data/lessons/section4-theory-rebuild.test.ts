...
describe("Dział 4 — przebudowa teoretyczna", () => {
  ...
  it("ma wyłącznie zadania powtórzeniowe z całego działu", () => {
    const contentStages = m54rBiuroProjektoweV1.stages.slice(1, -1);
    const questionCounts = contentStages.map((stage) => stage.questions.length);
