...
const CONTEXTS: Record<string, LessonSlideZeroContext> = {
  ...
  "M5-3.11": context("M5-3.11", "Dzielenie ułamków", ["V.1"], [
    "Nauczę się dzielić ułamek przez ułamek (mnożenie przez odwrotność).",
  ...
  "M5-4.2": context("M5-4.2", "Kąty i ich rodzaje", ["VIII.1", "VIII.4", "VIII.5"], [
    ...
    "Nauczę się rozpoznawać kąty: zerowy, ostry, prosty, rozwarty, półpełny, wklęsły i pełny.",
    "Nauczę się rozpoznawać kąty wypukłe i wklęsłe oraz oznaczać kąty literami greckimi.",
    "Nauczę się wskazywać kąty na figurze i rysować kąt o podanej nazwie z zaznaczonych punktów.",
  ]),
  ...
  "M5-4.5": context("M5-4.5", "Wielokąty", ["IX.1–5 (przygotowanie pojęciowe)", "XI.2 (tylko gdy występuje obwód)"], [
    "Nauczę się rozpoznawać wielokąty i nazywać je według liczby boków.",
    "Nauczę się wskazywać boki, wierzchołki, kąty i przekątne wielokąta.",
    "Nauczę się korzystać z tego, że wielokąt ma tyle samo boków, wierzchołków i kątów.",
    "Nauczę się obliczać obwód wielokąta i uzupełniać brakujące długości równych boków.",
  ]),
  "M5-4.6": context("M5-4.6", "Rodzaje trójkątów", ["IX.1"], [
    ...
    "Nauczę się obliczać obwód trójkąta albo brakującą długość boku na podstawie obwodu.",
  ]),
  ...
  "M5-4.8": context("M5-4.8", "Miary kątów w trójkątach", ["IX.3", "IX.8", "XI.1"], [
    ...
    "Nauczę się korzystać z równych kątów przy podstawie trójkąta równoramiennego.",
    "Nauczę się korzystać z tego, że każdy kąt trójkąta równobocznego ma 60°.",
  ]),
  "M5-4.9": context("M5-4.9", "Prostokąty i kwadraty", ["IX.4", "IX.5"], [
    ...
    "Nauczę się obliczać obwód lub brakujący bok prostokąta i kwadratu.",
  ]),
  "M5-4.10": context("M5-4.10", "Równoległoboki i romby", ["IX.4", "IX.5"], [
    ...
    "Nauczę się obliczać pozostałe kąty równoległoboku na podstawie jednego kąta.",
    "Nauczę się obliczać obwód lub brakujący bok równoległoboku i rombu.",
  ]),
  "M5-4.11": context("M5-4.11", "Trapezy", ["IX.4", "IX.5", "XI.1"], [
    "Nauczę się rozpoznawać trapezy oraz wskazywać ich podstawy i ramiona.",
  ...
  "M5-4.13": context("M5-4.13", "Oś symetrii", ["IX.5"], [
    "Nauczę się wyjaśniać, czym jest oś symetrii i figura osiowosymetryczna.",
    "Nauczę się wskazywać wszystkie osie symetrii figury.",
    "Nauczę się określać, ile osi symetrii ma dana figura.",
  ]),
  "M5-4.R": context("M5-4.R", "Powtórzenie wiadomości o figurach na płaszczyźnie", ["VII.2–3", "VIII.1–6", "IX.1–5", "IX.8", "XI.1"], [
    "Nauczę się samodzielnie rozpoznawać proste i obliczać kąty z wykorzystaniem ich własności.",
    "Nauczę się samodzielnie sprawdzać możliwość zbudowania trójkąta oraz obliczać jego kąty.",
    "Nauczę się samodzielnie korzystać z własności czworokątów i obliczać obwody wielokątów.",
    "Nauczę się krótko uzasadniać każde rozwiązanie odpowiednią własnością figury.",
  ]),
