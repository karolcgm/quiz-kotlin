...
export const m615DzialaniaUlamkiZwykleV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    ...
    { suffix: "same-denom-independent", kind: "practice", title: "Dodawanie i odejmowanie o jednakowych mianownikach", minutes: 7, headline: "Łączymy lub odejmujemy części tej samej wielkości", body: "Wykonaj krótką serię bardziej wymagających działań. Dodaj albo odejmij liczniki, zachowaj mianownik i skróć wynik, gdy jest to możliwe.", modelId: "fraction-lesson", modelSeed: 61505, questions: questions("same-denom", 3, "M6-1.5-add-sub-same", 615050), preserveTaskTitle: true, studentInstruction: "Wypełnij działanie poziomo i zatwierdź dopiero po wpisaniu wyniku w najprostszej postaci.", teacherInstruction: "Po jednym sprawdzeniu reguły przejdź do trudniejszych działań; nie powtarzaj łatwych przykładów z tym samym mianownikiem." },
    { suffix: "different-denom-l2-subtraction-bars", kind: "practice", title: "Dodawanie ułamków o różnych mianownikach", minutes: 12, headline: "Najpierw wspólny mianownik, potem dodawanie liczników", body: "Sprowadź oba ułamki do wspólnego mianownika. Następnie dodaj liczniki i zachowaj wspólny mianownik.", modelId: "fraction-lesson", modelSeed: 61506, questions: questions("different-denom-addition", 1, "M6-1.5-add-different", 615060), preserveTaskTitle: true, studentInstruction: "Wpisz licznik pierwszego ułamka po rozszerzeniu, licznik drugiego ułamka i licznik wyniku. Mianownik pozostaje wspólny.", teacherInstruction: "To jest prosty zapis z klasy 5: najpierw wspólny mianownik, potem dodawanie liczników. Nie dodajemy mianowników." },
    { suffix: "m5-3-8-reasoning", kind: "practice", title: "Ułamek liczby naturalnej", minutes: 8, headline: "Skróć liczbę naturalną z mianownikiem, a potem pomnóż", body: "Zapisz mnożenie ułamka przez liczbę naturalną. Skreśl mianownik z liczbą naturalną, wpisz liczby po skróceniu i oblicz wynik.", modelId: "fraction-lesson", modelSeed: 61507, questions: questions("fraction-of-number", 5, "M6-1.5-fraction-of-number", 615070), preserveTaskTitle: true, studentInstruction: "Najpierw odczytaj ułamek liczby jako mnożenie. Wpisz liczby po skróceniu w małe kratki, a po znaku równości wpisz wynik.", teacherInstruction: "Uczeń powinien widzieć skreślenie mianownika i liczby naturalnej. Wszystkie małe kratki oraz wynik uzupełnia jednym kalkulatorem lekcyjnym." },
