...
export const m427SystemRzymskiV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    ...
    { suffix: "check-record", kind: "challenge", title: "Czy zapis jest prawidłowy?", minutes: 10, headline: "Zaznacz prawidłowe", body: "Zaznacz wszystkie pary, w których liczba naturalna i zapis rzymski mają tę samą wartość.", modelId: "grade4-roman-numerals-lab", modelSeed: 4275, questions: questions("check-record", 1, "M4-2.7-check", 427300), preserveTaskTitle: true, studentInstruction: "Odczytaj wszystkie zapisy rzymskie i zaznacz każdą prawidłową parę.", teacherInstruction: "Po odpowiedzi omów z uczniami poprawny zapis każdej nieprawidłowej pary." },
  ],
  status: "published",
});
