...
export const m427SystemRzymskiV1 = buildLessonPackage({
  ...
  stageBlueprints: [
    ...
    { suffix: "check-record", kind: "challenge", title: "Czy zapis jest prawidłowy?", minutes: 10, headline: "Sprawdź parę", body: "Określ, czy liczba naturalna i zapis rzymski mają tę samą wartość.", modelId: "grade4-roman-numerals-lab", modelSeed: 4275, questions: questions("check-record", 8, "M4-2.7-check", 427300), preserveTaskTitle: true, studentInstruction: "Odczytaj zapis rzymski i zdecyduj, czy para jest prawidłowa.", teacherInstruction: "Po odpowiedzi poproś o podanie poprawnego zapisu każdej nieprawidłowej pary." },
  ],
  status: "published",
});
