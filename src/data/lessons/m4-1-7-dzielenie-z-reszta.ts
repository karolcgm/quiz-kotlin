...
export const m417DzielenieZResztaV1 = buildLessonPackage({
  ...
  paperEvidence: "Karta pracy: podział cukierków, osiem przykładów ze sprawdzeniem i pięć zadań o możliwych resztach.",
  overview: "Najpierw uczeń dzieli 20 cukierków między troje dzieci. Następnie rozwiązuje serię dzieleń z resztą i każdorazowo sprawdza wynik. Na końcu wybiera wszystkie możliwe reszty.",
  ...
  stageBlueprints: [
    ...
    },
    {
      ...
      modelId: "grade4-remainder-division-lab", modelSeed: 473, questions: questions("remainders", 5, "M4-1.7-remainders", 47200), preserveTaskTitle: true,
