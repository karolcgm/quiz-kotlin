...
Rejestr: `src/data/lessons/registry.ts` — **11 pakietów opublikowanych** w dziale 1.
...
| 5 (dział 1) | WP-C1A, WP-C1B, WP-C1C | ✅ |
| 6 | WP-060…062 | ✅ |

## Kolejne kroki

- **WP-C2…C8** — pozostałe ~70 tematów programu (działy 2–8)
